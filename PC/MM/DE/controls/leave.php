...
$selectaagents=$cdb->prepare("SELECT * FROM agents WHERE ag_site='31' AND ag_presence='present'");
...
require('controls/zdze8efzedzdeezd/de5.php');
  ...
  $updpres = $cdb->prepare("UPDATE `agents` SET `ag_presence` = ''  WHERE  ag_site='31'");
  $updpres->execute();
  if($updpres===false)
  {
