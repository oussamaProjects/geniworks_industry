...
$selectagents=$cdb->prepare("SELECT * FROM admin");
$selectagents->execute();
if ($selectagents===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
else{
  $resadmin=$selectagents->get_result();?>
											<div class="kt-portlet kt-portlet--height-fluid">
												...
												<div class="kt-portlet__body">
													<div class="kt-widget-4">
														<?php while ($showagent=$resadmin->fetch_row()) {?>
															...
															<div class="kt-widget-4__item-content">
																<div class="kt-widget-4__item-section">
																	...
																	<div class="kt-widget-4__item-info">
																		<a href="#" class="kt-widget-4__item-username">X</a>
																		<div class="kt-widget-4__item-desc">HR LV 2</div>
																	</div>
																</div>
															</div>
															<div class="kt-widget-4__item-content">
