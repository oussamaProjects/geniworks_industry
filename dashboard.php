...
$('a[href^="#"]').on('click', function(event) {
    ...
    if( target.length ) {
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>Dashboard | MyDADJE Solution</title>
...
?>
		...
		<script src="SRF/assets/js/demo1/pages/dashboard.js" type="text/javascript"></script>
		
		<script src="SRF/assets/js/demo1/scripts.bundle.js" type="text/javascript"></script>
		<script src="SRF/assets/js/demo1/pages/components/extended/sweetalert2.js" type="text/javascript"></script>
		<script src="SRF/assets/js/demo1/pages/components/base/toasts.js" type="text/javascript"></script>
...
<?php
    ...
    alert('Invalid Informations, Retry.');
}
