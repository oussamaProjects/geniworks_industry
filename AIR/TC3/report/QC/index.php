                        ...
                        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    <a href="../../../AIR/TC3/" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                                    
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    <a href="../../../AIR/TC3/" class="kt-subheader__breadcrumbs-link">
                                        Reports </a>
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    <a href="../TC3/" class="kt-subheader__breadcrumbs-link">
                                        TC3 </a>
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn-group" role="group" aria-label="Medium group">
                                                        <button type="button" class="btn btn-info active" onclick=" QCl()">QC</button>
...
$selectbcg=$cdb->prepare("SELECT * FROM asset_tc3 WHERE ast_internal_id  ='QC'");
$selectbcg->execute();
if ($selectbcg===false) {
...
while ($showbcg=$resbcg->fetch_row()) {
                                ?>
                                                        <a href="index.php?qcnum=<?php echo $showbcg[4]?>" style="margin-bottom: 5px; width: 65px;" class="btn btn-outline-info" onclick=" <?php echo $showbcg[4]?>()"><?php echo $showbcg[4]?></a>
                                         <?php }}?>
...
require('../../controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner  ='32' AND acij_asset='QC' AND acij_subasset_id='$qcnum'");
$showpsrf->execute();
if ($showpsrf===false) {
                                        ...
                                        <div class="kt-blog-grid">
                                            <div class="kt-blog-grid__head">
                                                <div id="demo-test-gallery" class="demo-gallery" data-pswp-uid="3">
                                                    <div class="container">
                                                  <a href="#" data-toggle="modal" data-target=".qczoom<?php echo $showasset[0];?>">
