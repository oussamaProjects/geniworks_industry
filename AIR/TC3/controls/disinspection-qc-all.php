...
$showasn=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC' LIMIT 1");
$showasn->execute();
if ($showasn===false) {
...
<div class="carousel-item active kt-slider__body">
                                            ...
                                            <?php }?>
																		...
																		<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showasn=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC'");
$showasn->execute();
if ($showasn===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
