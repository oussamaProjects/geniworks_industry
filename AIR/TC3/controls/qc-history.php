...
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC' LIMIT 5 OFFSET 0");
$showpsrf->execute();
if ($showpsrf===false) {
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC' LIMIT 5 OFFSET 5");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC' LIMIT 5 OFFSET 10");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                            ...
                                            <?php }?>
													...
													<div id="qcp4" class="tab-pane fade">
														<div class="kt-widget-6__items">
															...
															<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_tc3 WHERE acij_owner	='32' AND acij_asset='QC' LIMIT 5 OFFSET 15");
$showpsrf->execute();
if ($showpsrf===false) {
