												...
												<div class="form-group row">
													<div class="col-lg-3 col-md-3 col-sm-3">
														...
														<select onChange="aassets(this);" onselect="userTyped('skipID', this)" required="required" class="form-control kt_selectpicker"  >
															...
															<option value="BCG">Boom Crane G</option>
															<option value="BCP">Boom Crane P</option>
															<option value="BCM">Boom Crane M</option>
													...
													<div class="col-lg-3 col-md-3 col-sm-3">
														...
														<div class="BCG box">
                                                           <select class="form-control kt_selectpicker" data-live-search="true"  required="required" onChange="checkOption(this),subassetsidg(this);" id="subassetid1g">
                                                                	...
                                                                	<option data-subtext="BC G" value="G10001">G10001</option>
														...
														<div class="BCM box">
                                                           <select class="form-control kt_selectpicker" data-live-search="true" required="required" onChange="checkOption(this),subassetsidm(this);" id="subassetid1m">
                                                                	<option value="" selected="">Select Crane ID</option>
                                                                	<option data-subtext="BC M" value="M63001">M63001</option>
														...
														<div class="BCP box">
                                                           <select class="form-control kt_selectpicker" data-live-search="true" required="required" onChange="checkOption(this),subassetsidp(this);" id="subassetid1p">
                                                                	<option value="" selected="">Select Crane ID</option>
                                                                	<option data-subtext="BC P" value="P14001">P14001</option>
            ...
            $( "select option:selected").each(function(){
                ...
                if($(this).attr("value")=="choose"){
                    ...
                    $(".choose").show();
												...
												<div class="form-group row">
													<input type="text"  onchange="userTyped('skipID', this),subassetsidg(this);" id="supusssetinput" placeholder="Sub-Asset ID"  class="form-control kt_selectpicker" style="width: 200px;">
