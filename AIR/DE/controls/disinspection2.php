...
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner	='31' AND acij_asset='Boom Crane P' LIMIT 1");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "Ops! Issue In YARDS And GROUNDS Data Export!";
}
else{
											...
											<div class="kt-blog-grid__head">
												<div class="ctn" style="">
													<span style="">
														<div class="img-w">
															<center>
																<img src="img/assets/<?php echo $showasset[5];?>" style="width: 230px;" class="" />
															</center>
														</div>
