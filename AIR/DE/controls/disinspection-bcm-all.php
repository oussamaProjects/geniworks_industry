...
$showasn=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner	='31' AND acij_asset='Boom Crane M' LIMIT 1");
$showasn->execute();
if ($showasn===false) {
...
<div class="carousel-item active kt-slider__body">
														<div class="kt-widget-13">
															<div class="kt-widget-13__body">
																...
																<a class="kt-widget-13__title" href="report/BCM/index.php?BCMnum=<?php echo $showasset[4];?>"><?php echo $showasset[2];?> | <?php echo $showasset[3];?> | <?php echo $showasset[4];?> </a>
														...
														?></span>
																...
																<div class="kt-widget-13__toolbar">
																	<a href="#" data-toggle="modal" data-target=".BCMinsp" class="btn btn-default btn-sm btn-bold btn-upper">Details</a>
																</div>
															</div>
														</div>
													</div>
                                            ...
                                            <?php }?>
																		...
																		<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showasn=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner	='31' AND acij_asset='Boom Crane M'");
$showasn->execute();
if ($showasn===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
