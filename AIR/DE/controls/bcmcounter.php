...
.kt-widget-16__title :hover{
    ...
    transition: all 0.3s;
								...
								<div class="kt-widget-16__labels">
															...
															<div class="kt-widget-16__title">Boom Crane M</div>
														
														<div class="kt-widget-16__desc"><a href="report/BCM/" style="color: #00A1DB;" target="_blank">View Report</a></div>
													</div>
													<div class="kt-widget-16__data">
														
														<?php
require('controls/zdze8efzedzdeezd/de5.php');
$countinqc=$cdb->prepare("SELECT  count(acij_asset) FROM asset_clean_inspection_de WHERE acij_owner='31' AND acij_asset='Boom Crane M' AND acij_clean='1'");
$countinqc->execute();
if ($countinqc===false) {
									...
									.kt-widget-16 .kt-widget-16__item.kt-widget-16__item--success .kt-widget-16__data .kt-widget-16__numbers .kt-widget-16__numbers-change {
                                            ...
                                            <?php }?>
													...
													<div class="kt-widget-16__data">
														...
														<?php
require('controls/zdze8efzedzdeezd/de5.php');
$countinqcn=$cdb->prepare("SELECT  count(acij_asset) FROM asset_clean_inspection_de WHERE acij_owner='31' AND acij_asset='Boom Crane M' AND acij_call='1'");
$countinqcn->execute();
if ($countinqcn===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
