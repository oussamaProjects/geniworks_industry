...
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de_de WHERE acij_owner	='31' AND acij_asset='Boom Crane P' LIMIT 3 OFFSET 0");
$showpsrf->execute();
if ($showpsrf===false) {
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de_de WHERE acij_owner	='31' AND acij_asset='Boom Crane P' LIMIT 3 OFFSET 3");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de_de WHERE acij_owner	='31' AND acij_asset='Boom Crane P' LIMIT 3 OFFSET 6");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                            ...
                                            <?php }?>
													...
													<div id="ygp4" class="tab-pane fade">
														<div class="kt-widget-6__items">
															...
															<?php
require('controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner	='31' AND acij_asset='BCP' LIMIT 3 OFFSET 9");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
