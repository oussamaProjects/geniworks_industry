...
.nav-pills .nav-item .nav-link:active, .nav-pills .nav-item .nav-link.active, .nav-pills .nav-item .nav-link.active:hover {
    ...
    color: #ffffff;
									...
									<div class="row">
								<div class="col-lg-3 col-xl-4 order-lg-1 order-xl-1">
									<div class="kt-portlet kt-portlet--height-fluid kt-widget ">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">Boom Crane G Inspection Summary</div>
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-bcg-all.php');?>
									...
									<div class="modal fade qcinsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">Boom Crane G Inspections</h5>
														...
														<div id="" style=""><?php include('controls/bcg-history.php');?>
								...
								<div class="col-lg-3 col-xl-4 order-lg-1 order-xl-1">
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget ">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">Boom Crane M Inspection Summary</div>
													<div class="kt-slider__nav">
														<a class="kt-slider__nav-prev carousel-control-prev" style="color: #00A1DB;" href="#kt-widget-slider-13-1" role="button" data-slide="prev">
															<i class="fa fa-angle-left"></i>
														</a>
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-bcm-all.php');?>
									...
									<div class="modal fade qcinsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">Boom Crane M Inspections</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
														...
														<div id="" style=""><?php include('controls/bcm-history.php');?>
								...
								<div class="col-lg-3 col-xl-4 order-lg-1 order-xl-1">
									<div class="kt-portlet kt-portlet--height-fluid kt-widget ">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">Boom Crane P Inspection Summary</div>
													<div class="kt-slider__nav">
														<a class="kt-slider__nav-prev carousel-control-prev" style="color: #00A1DB;" href="#kt-widget-slider-13-1" role="button" data-slide="prev">
															<i class="fa fa-angle-left"></i>
														</a>
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-bcp-all.php');?>
									...
									<div class="modal fade qcinsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">Boom Crane P Inspections</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
														...
														<div id="" style=""><?php include('controls/bcp-history.php');?>
										...
										<div class="kt-portlet__body">
											<div class="kt-widget-16">
												...
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/bcgcounter.php')?>
												</div>
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/bcmcounter.php')?>
												</div>
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/bcpcounter.php')?>
												</div>
