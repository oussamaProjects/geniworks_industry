...
<meta charset="utf-8" />
        <title>BCG - Assets Inspection Record | GENIWORKS</title>
                        ...
                        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                            <div class="kt-subheader__main">
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    <a href="../../../AIR/DE/" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                                    
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    <a href="../../../AIR/DE/" class="kt-subheader__breadcrumbs-link">
                                        Reports </a>
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                    <a href="../BCG/" class="kt-subheader__breadcrumbs-link">
                                        DE </a>
                                    <span class="kt-subheader__breadcrumbs-separator"></span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn-group" role="group" aria-label="Medium group">
                                                        <button type="button" class="btn btn-outline-info" onclick=" BCGl()">BCG</button>
                                                        <button type="button" class="btn btn-info active" onclick=" BCMl()">BCM</button>
                                                        <button type="button" class="btn btn-outline-info" onclick=" BCPl()">BCP</button>
...
$selectbcm=$cdb->prepare("SELECT * FROM asset_de WHERE ast_internal_id  ='BCM'");
$selectbcm->execute();
if ($selectbcm===false) {
  ...
  $resbcm=$selectbcm->get_result();
while ($showbcm=$resbcm->fetch_row()) {
                                ?>
                                                        <a href="index.php?bcmnum=<?php echo $showbcm[4]?>" style="margin-bottom: 5px; width: 70px; align-content: center;" class="btn btn-outline-info" onclick=" <?php echo $showbcm[4]?>()"><?php echo $showbcm[4]?></a>
                                         <?php }}?>
                                        </div>
                                    </div>
                                </div>
 ...
 if (isset($_GET['bcmnum'])) {
     $bcmnum=$_GET['bcmnum'];
 
require('../../controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner  ='31' AND acij_asset='Boom Crane M' AND acij_subasset_id='$bcmnum'");
$showpsrf->execute();
if ($showpsrf===false) {
...
<style>
  ...
  if (mysqli_num_rows($respsrf)==0) { 
    ...
    echo "<center>No Data for This Boom Crane M!</center>";
  ?>
                                                        ...
                                                        <div class="modal-dialog modal-ml">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <span>No Data For This Boom Crane M!</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="kt-blog-grid">
                                            <div class="kt-blog-grid__head">
                                                <div id="demo-test-gallery" class="demo-gallery" data-pswp-uid="3">
                                                    <div class="container">
                                                  <a href="#" data-toggle="modal" data-target=".BCGzoom<?php echo $showasset[0];?>">
              ...
              <figure><h2 class="kt-blog-grid__title">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="kt-blog-grid__body">
                                                    ...
                                                    <div class="modal fade BCGzoom<?php echo $showasset[0];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
