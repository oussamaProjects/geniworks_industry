                                ...
                                <div class="kt-subheader__breadcrumbs">
                                 ...
                                 <div class="kt-separator kt-separator--space-sm kt-separator--border-dashed"></div>
                                                    <div class="btn-group" role="group" aria-label="Medium group">
                                                        ...
                                                        <button type="button" class="btn btn-outline-info" onclick=" BCMl()">BCM</button>
                                                        <button type="button" class="btn btn-info active" onclick=" BCPl()">BCP</button>
...
$selectbcp=$cdb->prepare("SELECT * FROM asset_de WHERE ast_internal_id  ='BCP'");
$selectbcp->execute();
if ($selectbcp===false) {
  ...
  $resbcp=$selectbcp->get_result();
while ($showbcp=$resbcp->fetch_row()) {
                                ?>
                                                        <a href="index.php?bcpnum=<?php echo $showbcp[4]?>" style="margin-bottom: 5px; width: 70px; align-content: center;" class="btn btn-outline-info" onclick=" <?php echo $showbcp[4]?>()"><?php echo $showbcp[4]?></a>
                                         <?php }}?>
...
<?php
 ...
 if (isset($_GET['bcpnum'])) {
     $bcpnum=$_GET['bcpnum'];
require('../../controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner  ='31' AND acij_asset='Boom Crane P'  AND acij_subasset_id='$bcpnum'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Data Export!";
}
...
while ($showasset=$respsrf->fetch_row()) {
                                        ...
                                        <div class="kt-blog-grid">
                                            <div class="kt-blog-grid__head">
                                                <div id="demo-test-gallery" class="demo-gallery" data-pswp-uid="3">
                                                    <div class="container">
                                                  <a href="#" data-toggle="modal" data-target=".BCPzoom<?php echo $showasset[0];?>">
        ...
        <div class="modal fade BCPzoom<?php echo $showasset[0];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
