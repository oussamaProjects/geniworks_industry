                                ...
                                <div class="kt-subheader__breadcrumbs">
                                 ...
                                 <div class="kt-separator kt-separator--space-sm kt-separator--border-dashed"></div>
                                                    <div class="btn-group" role="group" aria-label="Medium group">
                                                        <button type="button" class="btn btn-info active" onclick=" BCG()">BCG</button>
                                                        <button type="button" class="btn btn-outline-info" onclick=" BCM()">BCM</button>
                                                        <button type="button" class="btn btn-outline-info" onclick=" BCP()">BCP</button>
...
$selectbcg=$cdb->prepare("SELECT * FROM asset_de WHERE ast_internal_id  ='BCG'");
$selectbcg->execute();
if ($selectbcg===false) {
  ...
  $resbcg=$selectbcg->get_result();
while ($showbcg=$resbcg->fetch_row()) {
                                ?>
                                                        <a href="index.php?bcgnum=<?php echo $showbcg[4]?>" style="margin-bottom: 5px; width: 70px; align-content: center;" class="btn btn-outline-info" onclick=" <?php echo $showbcg[4]?>()"><?php echo $showbcg[4]?></a>
                                         <?php }}?>
...
<?php
 ...
 if (isset($_GET['bcgnum'])) {
     $bcgnum=$_GET['bcgnum'];
require('../../controls/zdze8efzedzdeezd/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection_de WHERE acij_owner  ='31' AND acij_asset='Boom Crane G'  AND acij_subasset_id='$bcgnum'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Data Export!";
}
...
<style>
  ...
  if (mysqli_num_rows($respsrf)==0) { 
    ...
    echo "<center>No Data for This Boom Crane G!</center>";
  ?>
                                                        ...
                                                        <div class="modal-dialog modal-ml">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <span>No Data For This Boom Crane G!</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
