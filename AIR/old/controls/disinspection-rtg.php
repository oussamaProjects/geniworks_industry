...
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection WHERE acij_owner	='11' AND acij_asset='RTG' ORDER BY acij_date DESC LIMIT 1");
$showpsrf->execute();
if ($showpsrf===false) {
...
<div class="kt-widget-5__item-info">
																<a href="#" class="kt-widget-5__item-title" data-toggle="modal" data-target=".rtginsp">
