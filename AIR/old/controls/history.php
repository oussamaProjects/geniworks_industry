...
$histqu = $cdb->prepare("SELECT * FROM asset_clean_inspection WHERE acij_owner='11' AND acij_asset='QC' AND acij_clean='' ORDER BY acij_clean ASC");
$histqu->execute();
if ($histqu===false) {
																	...
																	<div class="card">
																		...
																		<div id="collapseqc<?php echo $showasseth[0];?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample1" style="border-color:transparent;" >
																			<div class="card-body" style="border-color:transparent;">
																				...
																				<a href="owner/APM/QC/index.php?qcnum=<?php echo $showasseth[4];?>" ><strong>Report<i class="la la-angle-double-right"></i></strong></a>
																			</div>
																		</div>
																	</div>
																</div>
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$histqu = $cdb->prepare("SELECT * FROM asset_clean_inspection WHERE acij_owner='11' AND acij_asset='RTG' AND acij_clean='' ORDER BY acij_clean ASC");
$histqu->execute();
if ($histqu===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
																	...
																	<div class="card">
																		...
																		<div id="collapsertg<?php echo $showasseth[0];?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample1" style="border-color:transparent;" >
																			<div class="card-body" style="border-color:transparent;">
																				...
																				<?php echo $showasseth[3];?><br>
																				Inspected By <?php echo $showasseth[9];?><br>
																				<a href="owner/APM/RTG/index.php?rtgnum=<?php echo $showasseth[4];?>" ><strong>Report<i class="la la-angle-double-right"></i></strong></a>
																			</div>
																		</div>
																	</div>
																</div>
...
<?php
require('controls/zdze8efzedzdeezd/de5.php');
$histqu = $cdb->prepare("SELECT * FROM asset_clean_inspection WHERE acij_owner='11' AND acij_asset='YARDGROUND' AND acij_clean='' ORDER BY acij_clean ASC");
$histqu->execute();
if ($histqu===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
																	...
																	<div class="card">
																		...
																		<div id="collapseyg<?php echo $showasseth[0];?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample1" style="border-color:transparent;" >
																			<div class="card-body" style="border-color:transparent;">
																				...
																				<?php echo $showasseth[3];?><br>
																				Inspected By <?php echo $showasseth[9];?><br>
																				<a href="owner/APM/YARDSGROUNDS/" ><strong>Report<i class="la la-angle-double-right"></i></strong></a>
																			</div>
																		</div>
																	</div>
																</div>
