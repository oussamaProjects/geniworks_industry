  ...
  $resdate=$selectdate->get_result();?>
									...
									<div class="kt-portlet kt-portlet--height-fluid">
												...
												<?php while ($showdate=$resdate->fetch_row()) {
													if(strtotime($showdate[8]) < strtotime('-60 days')){
															...
															<div class="kt-widget-4__item-content">
																<div class="kt-widget-4__item-section">
																	...
																	<div class="kt-widget-4__item-info">
																		<a href="#" class="kt-widget-4__item-username"><?php echo $showdate[4];?> Inspected Since 60 Days Ago</a>
															...
															<div class="kt-widget-4__item-content">
																<div class="kt-widget-4__item-price">
																	<form action="profile.php" method="post">
																		...
																		<a class="btn btn-default btn-sm btn-bold btn-upper" href="owner/APM/QC/index.php?qcnum=<?php echo $showdate[4];?>">Details</a>
																	</form>
																</div>
															</div>
														</div>
