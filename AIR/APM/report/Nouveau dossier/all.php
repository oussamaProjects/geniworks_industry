...
while ($showasset=$respsrf->fetch_row()) {
                                        ...
                                        <div class="kt-blog-grid">
                                            <div class="kt-blog-grid__head">
                                                <div id="demo-test-gallery" class="demo-gallery" data-pswp-uid="3">
                                                    <div class="container">
                                                  <a href="../../controls/img/assets/<?php echo $showasset[5];?>" data-size="5000x6300" data-med="../../controls/img/assets/<?php echo $showasset[5];?>" data-med-size="" data-author="Othmane">
              ...
              <figure><h2 class="kt-blog-grid__title">
                                                    ...
                                                    <div class="kt-blog-grid__content">
                                                        ...
                                                        if ($showasset[6]=='') {
                                                            ?>
                                                                <span style="color: #00A1db;">Status :</span> <span style="color: #ef1f41;">Not Cleaned</span><br>
