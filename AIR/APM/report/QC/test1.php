...
$showpsrf=$cdb->prepare("SELECT * FROM asset_clean_inspection ");
$showpsrf->execute();
if ($showpsrf===false) {
...
while ($showasset=$respsrf->fetch_row()) {
                                ?> 
  <a href="#test1Content" class="group-cbox1 inline" title="Lorem ipsum 1"><img alt="" src="../../controls/img/assets/<?php echo $showasset[5];?>" width="100" class="shadow"></a>
  ...
  <div style='display:none'>
    <div id="test1Content" class="inner-overlay-box">
      <div class="media">
        <a href="#" class="img">
         <img src="../../controls/img/assets/<?php echo $showasset[5];?>" width="100" style="" class="img-inner-window" /></a>
