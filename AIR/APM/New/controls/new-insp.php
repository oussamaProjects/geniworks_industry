    ...
    color: #ffffff;
													...
													<div class="col-6" style="float: right;">
														<span class="kt-switch kt-switch--outline kt-switch--icon" style="color: #00A1DB;">
															<label>Call <img src="controls/img/favicon-32x32.png" width="10">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
															<label class="col-6 col-form-label">Dirt Degree</label>
														<div class=""> 
                                                                	<select onChange="" required="required" name="dirtdegree" class="form-control kt_selectpicker">
                                                                		<option data-subtext="Degree" value="">not specifiied</option>
                                                                        <option data-subtext="Degree" value="Low">Low</option>
                                                                        <option data-subtext="Degree" value="medium">Medium</option>
                                                                        <option data-subtext="Degree" value="high">High</option>
