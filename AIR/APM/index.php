...
.nav-pills .nav-item .nav-link:active, .nav-pills .nav-item .nav-link.active, .nav-pills .nav-item .nav-link.active:hover {
    ...
    color: #ffffff;
														...
														<ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
															...
															<li class="nav-item">
																<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35cb6c0fc43635" role="tab">
														...
														<div class="tab-content">
															<div class="tab-pane fade" id="kt_tabs_19_25cb6c0fc43635ssss" role="tabpanel">
								...
								<div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget ">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">QC Claims</div>
													<div class="kt-slider__nav">
														<a class="kt-slider__nav-prev carousel-control-prev" style="color: #00A1DB;" href="#kt-widget-slider-13-1" role="button" data-slide="prev">
															<i class="fa fa-angle-left"></i>
														</a>
														<a class="kt-slider__nav-next carousel-control-next" style="color: #00A1DB;" href="#kt-widget-slider-13-1" role="button" data-slide="next">
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-qc-all.php');?>
									...
									<div class="modal fade qcinsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">QC Inspections Claims</h5>
														...
														<div id="" style=""><?php include('controls/qc-history.php');?></div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-13">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-2" class="kt-slider carousel slide" data-ride="carousel" data-interval="4000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">RTG Claims</div>
													<div class="kt-slider__nav">
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-rtg-all.php');?>
												</div>
											</div>
										</div>
									</div>

									<div class="modal fade rtginsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">RTG Inspections Claims</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
														...
														<div id="" style=""><?php include('controls/rtg-history.php');?></div>
									...
									<div class="kt-portlet kt-portlet--height-fluid kt-widget-13">
										<div class="kt-portlet__body">
											<div id="kt-widget-slider-13-3" class="kt-slider carousel slide" data-ride="carousel" data-interval="12000">
												<div class="kt-slider__head">
													<div class="kt-slider__label">YARDS & GROUNDS Claims</div>
													<div class="kt-slider__nav">
												...
												<div class="carousel-inner">
													...
													<?php include('controls/disinspection-yardground-all.php');?>
												</div>
											</div>
										</div>
									</div>
<div class="modal fade yginsp" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">YARDS & GROUNDS Inspections Claims</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">&times;</span>
																	</button>
																</div>
														...
														<div id="" style=""><?php include('controls/yg-history.php');?></div>
							...
							<?php include('controls/history.php')?>
								</div>
															...
															<div class="tab-pane fade" id="kt_tabs_19_25cb6c0fc43635" role="tabpanel">
																<?php include('controls/report-filter.php') ?>
															</div>
									...
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">All Assets Report</h3>
											</div>
										...
										<div class="kt-portlet__body">
											<div class="kt-widget-16">
												...
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/qccounter.php')?>
												</div>
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/rtgcounter.php')?>
												</div>
												<div class="kt-widget-16__item kt-widget-16__item--brand">
													<?php include('controls/ygcounter.php')?>
												</div>
...
<?php include('controls/claims.php');?>
