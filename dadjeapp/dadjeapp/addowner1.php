...
<script>
     ...
     document.getElementById("as4").innerHTML = ownerr;
}
...
//});
                                ...
                                <div class="tab-pane active" id="assets" role="tabpanel">
                                    <div class="card-body">
                                        <form class="form-horizontal ">
                                            ...
                                            <div class="row">
                                                <label class="col-md-4">Sub-Asset</label>
                                                <div class="col-md-4">
                                                    <span id="subastn"></span>
                                                </div>
                                            </div>

                                            
                                            <div class="form-group">
                                                <?php include('shiptoshore.html'); ?>
                                            </div>
                ...
                <script>
     function clklFunction(element) {
     document.getElementById("subastn").innerHTML = "Legs";
}
function clkcFunction(element) {
     document.getElementById("subastn").innerHTML = "Container";
}
function clkmhFunction(element) {
     document.getElementById("subastn").innerHTML = "Machinery House";
}
function clkdcFunction(element) {
     document.getElementById("subastn").innerHTML = "Driver Cabin";
}
function clkbrFunction(element) {
     document.getElementById("subastn").innerHTML = "Back Reach";
}
function clkbmFunction(element) {
     document.getElementById("subastn").innerHTML = "Boom";
}
function clkgtFunction(element) {
     document.getElementById("subastn").innerHTML = "Gantry";
}
function clkhbFunction(element) {
     document.getElementById("subastn").innerHTML = "Head Block";
}
function clkspFunction(element) {
     document.getElementById("subastn").innerHTML = "Spreader";
}




     function clkrlgFunction(element) {
     document.getElementById("subastn").innerHTML = "Legs";
}
function clkrcnFunction(element) {
     document.getElementById("subastn").innerHTML = "Container";
}
function clkrdcFunction(element) {
     document.getElementById("subastn").innerHTML = "Driver Cabin";
}

function clkrrlFunction(element) {
     document.getElementById("subastn").innerHTML = "Rail";
}
function clkrgtFunction(element) {
     document.getElementById("subastn").innerHTML = "Gantry";
}
function clkrhbFunction(element) {
     document.getElementById("subastn").innerHTML = "Head Block";
}
function clkrspFunction(element) {
     document.getElementById("subastn").innerHTML = "Spreader";
}

function clkrgcFunction(element) {
     document.getElementById("subastn").innerHTML = "Gantry Cabin Side";
}
function clkrglFunction(element) {
     document.getElementById("subastn").innerHTML = "Gantry Land Side";
}
</script>s
                <!-- ============================================================== -->
                <!-- End Right sidebar -->
