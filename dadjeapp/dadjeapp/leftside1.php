                    ...
                    <ul id="sidebarnav">
                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="javascript:void()">WOF </a></li>
                            </ul>
                        </li>
                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                            <span class="hide-menu">Checklists </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="javascript:void()">DMC </a></li>
                                <li><a href="javascript:void()">DIC</a></li>
                                <li><a href="javascript:void()">PRF</a></li>
                            </ul>
                        </li><!--
