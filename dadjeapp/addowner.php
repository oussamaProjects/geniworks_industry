...
//});
                                ...
                                <div class="tab-pane active" id="assets" role="tabpanel">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group m-t-40  row">
                                                <div class="col-4">
                                                    <a href="javascript:void(0)" onClick="clkrtgFunction(this);">
                                                    <img src="img/grue-rtg.png"></a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="javascript:void(0)" onClick="clkstsFunction(this);">
                                                   <img src="img/grue-sts.png"></a>
                                                </div><!--
                                                <div class="col-4">
                                                <img src="https://img.icons8.com/ios-glyphs/90/000000/fishing-boat.png">
                                                </div>-->
                                                <div class="col-4">
                                                    <a href="javascript:void(0)" onClick="clkboomcFunction(this);">
                                                <img src="img/86816.png" ></a>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Sub-Asset</h4>
