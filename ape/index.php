...
<head>
    ...
    <title>APE Manager - MyDadje</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">APE MANAGER</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">APE</li>
                        </ol>
                    </div>
                    <div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-info m-t-10 float-left" data-toggle="modal" data-target="#add-contact">Add New APE</button>
                                <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Add APE</h4>
                    ...
                    <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="aassets" role="tabpanel">
                                    <form method='POST'  class="form-horizontal"  action='../controls/addape.php' enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="brnd" id="ebrnd" onChange="brndFunction(this);" class="form-control" placeholder="APE Name" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="apfunction" class="form-control" placeholder="APE Function" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="apsupplier" class="form-control" placeholder="APE Supplier" required="required">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="priceape" class="form-control" placeholder="APE Price" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
