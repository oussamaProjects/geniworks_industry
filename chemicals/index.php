...
<head>
    ...
    <title>Chemicals Manager - MyDadje</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">CHEMICALS MANAGER</h3>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-info m-t-10 float-left" data-toggle="modal" data-target="#add-contact">Add New chemical</button>
                                <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Add chemicals</h4> 
                    ...
                    <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="aassets" role="tabpanel">
                                    <form method='POST'  class="form-horizontal"  action='../controls/addchem.php' enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="brnd" id="ebrnd" onChange="brndFunction(this);" class="form-control" placeholder="chemical Name" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="serialnum" class="form-control" placeholder="Serial Number" required="required" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <label class="control-label col-md-4">Funtion</label>
                                                <div class="col-md-8">
                                                    <input type="text" name="cfunction" class="form-control" placeholder="Chemical Function" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="pricech" class="form-control" placeholder="Tool Price" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="csupplier" class="form-control" placeholder="Chemical Supplier" required="required">
...
<script>
    ...
    reader.readAsDataURL(event.target.files[0]);
                                ...
                                <div class="table-responsive">
                                    <?php include('../controls/showchem.php');?>
                                </div>
