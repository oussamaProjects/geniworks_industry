			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                     ...
                     <div class="col-lg-4 col-xl-3 order-lg-2 order-xl-1">
                     </div>
...
<?php } ?>
 ...
 <b style="color: #ffb822; text-transform: uppercase;">   <?php  echo date("Y-m-d H:i:s", strtotime($showcab[4].'-1 hour')); ?></b>
           ...
           <?php if($showcab[3]=="Not available"){ ?>
              <h2 class="name">Hlded on since</h2><span class="value">
...
<div class="kt-iconbox kt-iconbox--success">
    ...
    <div class="row" style="align-content: center;" align="center">
    	<?php if(($showcab[3]=="Not disinfected")||($showcab[3]=="Canceled")){?>
          ...
          <div class="col-lg-12">
													<button style="align-content: center;" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#exampleModalCenter">
     ...
     <?php if(($showcab[3]=="In progress")){?>
          ...
          <div class="col-lg-12">
												...
												Finish
													...
													<button style="align-content: center;" type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#exampleModalCenter">
														<i class="fa fa-biohazard"></i>
												Cancel
													</button>
												</div>
     <?php }?>		
								...
								<div class="kt-portlet__head-wrapper">
											...
											<div class="col-lg-9 col-md-9 col-sm-12">
												<input type="hidden" value="<?php echo $showcab[1]?>" name="cabinid">
