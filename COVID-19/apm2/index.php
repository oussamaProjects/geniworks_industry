	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="modal fade" id="loginpop" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
														<div class="modal-dialog modal-dialog-centered" role="document">
															<div class="modal-content">
																...
																<form action="../controls/log2.php" method="post">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " style="height: 80px;">
			<div class="kt-header-mobile__logo">
					...
					<a href="" data-toggle="modal" data-target="#loginpop"><img alt="Logo" src="../../img/logo-v3.png" width="115" style="" /></a>
...
$selectdis=$cdb->prepare("SELECT count(*) FROM cabins WHERE cabn_owner='APM-TERMINALS 02' AND cabn_status='Disinfected' AND (cabn_asset LIKE 'EXTERNAL BUS%' OR cabn_asset LIKE 'External Bus%') AND cabn_last_ops >= DATE_SUB(NOW(),INTERVAL 8 HOUR) ORDER BY cabn_id DESC");
$selectdis->execute();
if ($selectdis===false) {
  echo "We Have Problem! We will fix it soon.";
}
...
<span style="color: #1dc9b7;"><?php echo $showdis[0];      ?></span> EXTERNAL BUS<br>
...
<span style="color: #fd397a;"><?php echo $showdis[0];      ?></span> EXTERNAL BUS<br>
