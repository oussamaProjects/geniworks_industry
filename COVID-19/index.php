...
body {
  ...
  /* Opera 11.10+ */
  /* IE10+ */
  background: linear-gradient(135deg, #0d1429 0%, #2d78ad 100%);
  /* W3C */
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#0d1429 ', endColorstr='#2d78ad',GradientType=1 );
  ...
  <div class='container_inner'>
    <div class='container_inner__login'>
      <div class='login'>
        ...
        <div class='login_desc' style="">
        	<h1 style="color: white; width: 250px; font-size: 36px; display:table; margin-left: -20px; align-items: center; text-align: center;">ANTI-PANIC COVID19 PLAN </h1>
          <base href="https://raw-dot-custom-elements.appspot.com/LostInBrittany/granite-qrcode-scanner/1.5.1/granite-qrcode-scanner/">
...
<dom-bind>
  <template>
    ...
    <div align="middle">
     <h1> <a  style="color: white;" onchange="window.open(this);" href="[[data]]"><i class="icon-remove-sign">[[data]]</i></a></h1>
