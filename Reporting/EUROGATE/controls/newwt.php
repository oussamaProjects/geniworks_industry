<div id="witmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          	<h4 class="modal-title">New Witness</h4>
            ...
            <form method="post" class="newwitness kt-form kt-form--label-right">
            	<div class="kt-portlet__body">
            		<div class="form-group form-group-last">
            			<div class="alert alert-secondary" role="alert">
            				...
            				You Can Define New Witness With The Informations Below.
            				</div>
            			</div>
            		</div>
            		...
            		<div class="form-group ">
            			...
            			<div class="kt-input-icon kt-input-icon--right">
            				<input type="text" name="wid" class="form-control" placeholder="">
            			</div>
            	...
            	<div class="kt-portlet__foot">
            		<div class="kt-form__actions">
            			<input type="submit"  name="addw" class="btn btn-brand" value="Add">
            		</div>
            	</div>
            </form>
          </div>
