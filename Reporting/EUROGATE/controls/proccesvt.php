...
?>
														<select id='prosvtn<?php echo $showrepvt[0];?>' class="form-control kt_selectpicker" data-live-search="true" name="processrep">
															<?php if ($showrepvt[44]!="") { ?>
															...
															<?php
															 ...
															 <option data-subtext="" value="<?php echo $showresultspec[1]?>"><?php echo $showresultspec[2]?></option>
                                                                    <?php }?>
															<option value="newprosvt">Other Procces</option>
														</select>
<?php
}
?>
