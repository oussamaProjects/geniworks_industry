      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
          	<h4 class="modal-title">New Revealer</h4>
            ...
            <form method="post" class="newwitness kt-form kt-form--label-right">
            	<div class="kt-portlet__body">
            		<div class="form-group form-group-last">
            			<div class="alert alert-secondary" role="alert">
            				...
            				You Can Define New Revealer With The Informations Below.
            				</div>
            			</div>
            		</div>
            		<div class="form-group ">
            			...
            			<div class="kt-input-icon kt-input-icon--left">
            				<input type="text" name="rname" class="form-control" placeholder="">
            			</div>
            		...
            		<div class="form-group ">
            			...
            			<div class="kt-input-icon kt-input-icon--right">
            				<input type="text" name="rid" class="form-control" placeholder="">
            			</div>
            	...
            	<div class="kt-portlet__foot">
            		<div class="kt-form__actions">
            			<input type="submit"  name="addr" class="btn btn-brand" value="Add">
            		</div>
            	</div>
            </form>
          </div>
