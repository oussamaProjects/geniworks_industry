...
if (($showreport[4]=='04') && ($showreport[2]=='QC')) {
...
$pdf->setFillColor(184,204,228);
$pdf->Cell(190 ,5,iconv('UTF-8', 'ISO-8859-2', 'Observations / Comments'),1,1,'C',1);
...
$pdf->Cell(189 ,0,'',0,1);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(31 ,5,'Keys',1,0,'C');
$pdf->SetFont('Arial','B',7);
$pdf->Cell(159 ,5,'ACC - acceptable/ CR - Crack IP - Incomplete Penetration/ IF - Incomplete Fusion/ SL - Slag/ P - Porosity/  EX - Excess Penetration',1,1);
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,iconv('UTF-8', 'ISO-8859-2', "Nom / Name:Marouane FARIH"),'L',0);
