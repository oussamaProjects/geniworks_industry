...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_tools_request WHERE str_owner='11' AND str_order_date BETWEEN '2019-7-11' AND '2005-8-11'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$pdf->Cell(55 ,5,'',0,0,1);
$pdf->Cell(75 ,5,'SRF / Bon De Commande N#006',0,0,1);
