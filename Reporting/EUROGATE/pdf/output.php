...
$pdf->Cell(189 ,5,'',0,1);
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,iconv('UTF-8', 'ISO-8859-2', "Pince éléctromagnétique / Contact Clamp"),1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(128 ,5,'Marque / Mark:                '.$showreport[27].'                  Identification / ID:'.' B2009/CE     ',1,1);
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,'Lampe UV / Black Light Lamp',1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(128 ,5,'Marque / Mark:                Type / Type : B104B                   N# Lot / Batch N#:'.' 12318     ',1,1);
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,'Type de courant / Type Of Current',1,0);
$pdf->SetFont('Arial','',9);

$pdf->Cell(35 ,5,'Alternatif / A.C:     48V  ',0,0);
if($showreport[31]=='48'){
$pdf->Cell(5 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),0,0);
$pdf->Cell(15 ,5,'    110V  ',0,0);
$pdf->Cell(5 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
$pdf->Cell(15 ,5,'    220V  ',0,0);
$pdf->Cell(5 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
$pdf->Cell(30 ,5,'    Continu / D.C:    ',0,0);
$pdf->Cell(18 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,1);
}
elseif($showreport[31]=='110'){
$pdf->Cell(5 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
$pdf->Cell(15 ,5,'    110V  ',0,0);
$pdf->Cell(5 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),0,0);
$pdf->Cell(15 ,5,'    220V  ',0,0);
...
$pdf->Cell(190 ,5,"Conditions d'examen / Examination condition",1,0,'C',1);

$pdf->Cell(189 ,5,'',0,1);
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,iconv('UTF-8', 'ISO-8859-2', "Témoin type / Witness Type"),1,0);
$pdf->SetFont('Arial','',9);

if($showreport[32]=='AFNOR'){
$pdf->Cell(33 ,5,'AFNOR',0,0);
$pdf->SetFont('Arial','B',9);

$unchecked = "unchecked.png";
$checked = "checked.png";

$pdf->Cell(17 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),0,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(29 ,5,'BERTHOLD',0,0);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(15 ,5,'ASME',0,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,1);
}

elseif($showreport[32]=='Berthold'){
	$unchecked = "unchecked.png";
$pdf->Cell(33 ,5,'AFNOR',0,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
...
elseif($showreport[32]=='AMSE'){
	$checked = "checked.png";
$unchecked = "unchecked.png";

$pdf->Cell(33 ,5,'AFNOR',1,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),0,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(29 ,5,'BERTHOLD',0,0);
...
$pdf->Cell(15 ,5,'ASME',0,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),1,1);
...
$pdf->Cell(33 ,5,'AFNOR',1,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(29 ,5,'BERTHOLD',1,0);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(15 ,5,'ASME',1,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(17 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,1);
}
$pdf->SetFont('Arial','',9);
$pdf->Cell(95 ,5,'Valeur du Champ / Magnetic Field Value'."                 ".$showreport[33]." A/M",1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(63 ,5,iconv('UTF-8', 'ISO-8859-2', "Démagnétisation / Demagnetization"),1,0);
$pdf->SetFont('Arial','B',9);

if($showreport[35]=='Yes'){
	$checked = "checked.png";
$pdf->Cell(4.5 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),0,0);
}elseif ($showreport[35]=='No') {
	$checked = "unchecked.png";
$pdf->Cell(4.5 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),5,5),0,0);
}
$pdf->Cell(27.5 ,5,'',1,1);
$pdf->SetFont('Arial','',9);
$pdf->Cell(95 ,5,'Espacement des poles / Prod Spacing'.'                      '.$showreport[34].'mm',1,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(95 ,5,iconv('UTF-8', 'ISO-8859-2', "Durée de Magnétisation / Magnetization Delay"."        ".$showreport[36]." sec"),1,1);

$pdf->SetFont('Arial','',9);
$pdf->Cell(50 ,5,iconv('UTF-8', 'ISO-8859-2', "Révélateur / Revealer"),1,0);
$pdf->SetFont('Arial','B',9);
$mark = ''.$showreport[37].'';
$pdf->SetFont('Arial','',9);
$pdf->Cell(140 ,5,'Marque / Mark:    '.$mark.'         Type / Type:     B103C            N# Lot / Batch N:    22018/2 ',1,1);


$checked = "checked.png";
$unchecked = "unchecked.png";
$pdf->SetFont('Arial','',9);
$pdf->Cell(50 ,10,iconv('UTF-8', 'ISO-8859-2', "Eclairage Utilisé / Light Used"),1,0);
$pdf->SetFont('Arial','',8);
$pdf->Cell(45 ,5,'Lumiere Naturelle / Natural Light',1,0);
$pdf->SetFont('Arial','B',9);

$pdf->SetFont('Arial','B',9);
if ($showreport[38]=='Natural') {
$pdf->Cell(20 ,5,$pdf->Image($checked, $pdf->GetX(), $pdf->GetY(),5,5),1,0);
}

elseif ($showreport[38]=='Black') {
$pdf->Cell(20 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,0);
}
$pdf->SetFont('Arial','',9);
$pdf->Cell(75,5,"Lumiere Artificielle / Artificial Light          " .$showreport[39]." lux",1,1);
$pdf->Cell(50 ,10,'',0,0);
$pdf->SetFont('Arial','',9);
$pdf->Cell(45 ,5,'Lumiere noire / Black Light',1,0);
$pdf->SetFont('Arial','B',9);
if ($showreport[38]=='Natural') {
$pdf->Cell(20 ,5,$pdf->Image($unchecked, $pdf->GetX(), $pdf->GetY(),4.5,4.5),1,0);
}
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(75 ,5,iconv('UTF-8', 'ISO-8859-2', "Intensité lumineuse / Brightness:            " .$showreport[40]."w/m"),1,1);
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(31 ,5,iconv('UTF-8', 'ISO-8859-2', "Repére / Handmark"),1,0,'c');
$pdf->Cell(31 ,5,iconv('UTF-8', 'ISO-8859-2', "Verdict / Verdict"),1,0,'c');
$pdf->Cell(33 ,5,iconv('UTF-8', 'ISO-8859-2', "Observations"),1,0,'c');

$pdf->Cell(33 ,5,iconv('UTF-8', 'ISO-8859-2', "Repére / Handmark"),1,0,'c');
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,iconv('UTF-8', 'ISO-8859-2', "Nom / Name:"),'L',0);

$pdf->SetFont('Arial','',9);
$pdf->Cell(66 ,5,iconv('UTF-8', 'ISO-8859-2', "Nom / Name:"),'L',0);

$pdf->SetFont('Arial','',9);
$pdf->Cell(62 ,5,'Nom / Name:','L',0);
$pdf->Cell(0 ,5,'','R',1);
