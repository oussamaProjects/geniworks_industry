...
<head>
    ...
    <title>Materials Manager - MyDadje</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">MATERIALS MANAGER</h3>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-info m-t-10 float-left" data-toggle="modal" data-target="#add-contact">Add New Material</button>
                                <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Add Materials</h4> 
                    ...
                    <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="aassets" role="tabpanel">
                                    <form method='POST'  class="form-horizontal"  action='../controls/addmat.php' enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="brnd" id="ebrnd" onChange="brndFunction(this);" class="form-control" placeholder="Material Name" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="mfunction" class="form-control" placeholder="Material Function" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="pricemal" class="form-control" placeholder="Material Price" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="msupplier" class="form-control" placeholder="Tool Supplier" required="required">
...
<script>
    ...
    reader.readAsDataURL(event.target.files[0]);
                                ...
                                <div class="table-responsive">
                                    <?php include('../controls/showmats.php');?>
                                </div>
