  	...
  	while ($showinfo=$resinfo->fetch_row()) {?>
		<div class="tab-pane fade show active" id="kt_profile_tab_personal_information" role="tabpanel">
													<div class="kt-portlet">
														...
														<form  id="forminfo" method="post" class="kt-form kt-form--label-right">
																...
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<div class="kt-avatar kt-avatar--outline kt-avatar--circle" id="kt_profile_avatar">
																					<div class="kt-avatar__holder" style="background-image: url(img/agents/<?php echo $showinfo[7];?>)"></div>
																		...
																		<div class="form-group row">
																			...
																			<div class="col-lg-9 col-xl-6">
																				<div class="input-group">
																					...
																					<input type="text" class="form-control" name="upemail" value="<?php echo $showinfo[32];?>" placeholder="Email" aria-describedby="basic-addon1">
																				</div>
																			</div>
																		</div>
																		<div class="form-group form-group-last row">
																			...
																			<?php }?>
																			<?php if ($showinfo[20]=='41') {
																				
																				?>
																				<div class="input-group">
																					
																					<div class="input-group-append"><span class="input-group-text">HTTSA</span></div>
																				</div>
																			<?php }?>
																			<?php if ($showinfo[20]=='51') {
																				
																				?>
																				<div class="input-group">
																					
																					<div class="input-group-append"><span class="input-group-text">BRAVE BOYS</span></div>
																				</div>
																			<?php }?>
																			</div>
																		</div>
																			...
																			<div class="col-lg-9 col-xl-6">
																				<div class="kt-checkbox-single">
																					<label class="kt-checkbox">
																						<input type="checkbox"> i accept that i edit that
																						<span></span>
																					</label>
																				</div>
																			</div>
