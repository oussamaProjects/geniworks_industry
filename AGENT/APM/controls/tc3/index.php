...
$selectagents=$cdb->prepare("SELECT * FROM agents WHERE ag_site='32'");
															...
															<div class="kt-widget-4__item-content">
																<div class="kt-widget-4__item-price">
																	<form action="profile.php" method="post">
																		...
																		<button class="btn btn-default btn-sm btn-bold btn-upper" data-toggle="modal" data-target="">Details</button>
																	</form>
																</div>
															</div>
														</div>
