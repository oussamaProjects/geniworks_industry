								...
								<div class="kt-widget-16__labels">
															...
															<div class="kt-widget-16__title">RTG</div>
														
														<div class="kt-widget-16__desc"><a href="owner/APM/RTG/" target="_blank">View Report</a></div>
													</div>
													<div class="kt-widget-16__data">
														
														<?php
require('controls/zdze8efzedzdeezd/de5.php');
$countinqc=$cdb->prepare("SELECT  count(acij_asset) FROM asset_clean_inspection WHERE acij_owner='11' AND acij_asset='RTG' AND acij_clean='1'");
$countinqc->execute();
if ($countinqc===false) {
								...
								?>
                                            ...
                                            <?php }?>
													...
													<div class="kt-widget-16__data">
														...
														<?php
require('controls/zdze8efzedzdeezd/de5.php');
$countinqcn=$cdb->prepare("SELECT  count(acij_asset) FROM asset_clean_inspection WHERE acij_owner='11' AND acij_asset='RTG' AND acij_call='1'");
$countinqcn->execute();
if ($countinqcn===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
