...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResiz@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c @hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
    @hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datat@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatabl@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addCla@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          .noRecords');
			...
			@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(eleme@hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU   @      `hPEÊU          ight(includeMargin);
    ...
    var initPageStickyPortlet = function() {
        return new KTPortlet('kt_page_portlet', {
            sticky: {
                ...
                zIndex: 90,
                position: {
                @hPEÊU  @hPEÊU                  €î£DÊU          0hOEÊU  ¨hPEÊU          `hPEÊU  m      `hPEÊU          onsiveRange('desktop')) {
