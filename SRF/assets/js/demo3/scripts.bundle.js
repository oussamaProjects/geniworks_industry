...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResiz°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c °3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
    °3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datat°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatabl°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addCla°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          .noRecords');
			...
			°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(eleme°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU   @      Ð3—'ËU          ight(includeMargin);
    ...
    var initPageStickyPortlet = function() {
        return new KTPortlet('kt_page_portlet', {
            sticky: {
                ...
                z°3—'ËU  °3—'ËU                   :'ËU          pI'ËU  4—'ËU          Ð3—'ËU  ›      Ð3—'ËU          var h = 0;
