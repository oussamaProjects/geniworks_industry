...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResiz _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c  _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
 _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
     _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datat _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatabl _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addCla _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          .noRecords');
			...
			 _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$ _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(eleme _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V   @      À_Ê‰V          ight(includeMargin);
...
var KTLayout = function() {
    ...
    return {
        ...
        initAside: function() { 
         ...
          _Ê‰V   _Ê‰V                  €¢Í‰V          àF$‰V  `Ê‰V          À_Ê‰V  ã      À_Ê‰V          tickyPortlet) {
