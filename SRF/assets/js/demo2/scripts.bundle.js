...
var KTUtil = function() {
    ...
    return {
        ...
        init: function(options) {
            ...
            _windowResizî›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          {function} callback function.
         */
        ...
        index: function( elm ){ 
            elm = KTUtil.get(elm);
            var c î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          m ) return i;
        },
...
var KTMenu = function(elementId, options) {
    ...
    var Plugin = {
         ...
         * Reset menu
         * @returns {KTMenu}
î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          event_1']);
...
var KTPortlet = function(elementId, options) {
    ...
    var Plugin = {
        ...
        construct: function(options) {
            ...
            return the;
    î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU              the.element = element;
            the.events = [];
		...
		var Plugin = {
				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datatî›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          table__lock ' + pfx + 'datatable__lock--scroll');
						...
						if (typeof column !== 'undefined') {
							...
							if (typeof column.subtable !== 'undefined' && column.subtable) {
								...
								$(td).
									children().
									html($('<a/>').
										addClass(pfx + 'datatablî›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
			...
			insertData: function() {
				...
				if (datatable.dataSet.length === 0) {
					...
					util.addClaî›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          .noRecords');
			...
			î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable__row').each(function() {
							...
							if ($(datatable.tableHead).find('.' + pfx + 'datatable__toggle-detail').length === 0) {
								...
								$î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
			...
			getHiddenDimensions: function(element, includeMargin) {
				...
				dim.height = $(elemeî›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU   @      0î›ØU          ight(includeMargin);
...
var KTLayout = function() {
    ...
    var initScrolltop = function() {
        var scrolltop = new KTScrolltop('kt_scrolltop', {
            offset: 300,
        î›ØU  î›ØU                   Y›ØU          àÍëšØU  xî›ØU          0î›ØU  Q      0î›ØU          unction() {
        var asideWidth = 280;
