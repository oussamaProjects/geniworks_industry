...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>SRM | Supply Recources Manager</title>
	...
	<!-- begin::Body -->
	<body  onload='holaa(11)' class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">

		<!-- begin:: Header Mobile -->
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="demo1/index.html">
					<img alt="Logo" src="img/logo-geniworks-2.png"  width="160"/>
				</a>
			</div>
									...
									<form class="kt-form kt-form--fit kt-margin-b-20">
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-xl">Request</button>
...
function holaa(x) {
                ...
                if(x == 12)  {
                    ...
                    document.getElementById("materials").style.display = 'block';
												...
												<div id="tools" style="position:relative;" class="form-group row">
													<label class="col-lg-2 col-form-label">Standard:</label>
													<div class="col-lg-3">
												...
												<div id="materials" style=" position:relative;" class="form-group row">
					...
					<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
						<div class="kt-footer__copyright">
							2019&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/keen" target="_blank" class="kt-link">Mydadje By GENIWORKS</a>
						</div>
