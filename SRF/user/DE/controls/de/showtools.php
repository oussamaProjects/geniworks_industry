...
<div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          ...
                                          <input min="0" onChange="myNewFunction(this)" id="actualde" value="<?php echo  "$showrow2[6]";?>" style=" color: #fd397a; " name="quantity1" type="number">
                                  ...
                                  <div class="kt-widget-14__info-title">
                                    <div class="number-input">
                                      <div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          <i class="fa fa-plus"></i></a>
                                          <input min="0" onChange="myNewFunction(this)" id="actualde" value="<?php echo  "$showrow2[6]";?>" style=" color: #ffb822; " name="quantity" type="number">
                                  ...
                                  <div class="kt-widget-14__info-title">
                                    <div class="number-input">
                                      <div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          <i class="fa fa-plus"></i></a>
                                          <input min="0" onChange="myNewFunction(this)" id="actualde" value="<?php echo  "$showrow2[6]";?>" style=" color: #1dc9b7; " name="quantity3" type="number">
