...
$sqlct="SELECT count(wtl_name) FROM work_tools_bmci WHERE wtl_owner = '41'";
$resultct = mysqli_query($cdb,$sqlct);

mysqli_select_db($cdb,"ajax_demo");
$sqlcm="SELECT count(wmt_name) FROM work_materials_bmci WHERE wmt_owner = '41'";
$resultcm = mysqli_query($cdb,$sqlcm);

mysqli_select_db($cdb,"ajax_demo");
$sqlcc="SELECT count(wch_name) FROM work_chemicals_bmci WHERE wch_owner = '41'";
$resultcc = mysqli_query($cdb,$sqlcc);

mysqli_select_db($cdb,"ajax_demo");
$sqlca="SELECT count(wape_name) FROM work_ape_bmci WHERE wape_owner = '41'";
$resultca = mysqli_query($cdb,$sqlca);

mysqli_select_db($cdb,"ajax_demo");
$sqlcp="SELECT count(wppe_name) FROM work_ppe_bmci WHERE wppe_owner = '41'";
$resultcp = mysqli_query($cdb,$sqlcp);



mysqli_select_db($cdb,"ajax_demo");
$sql="SELECT wtl_name,wtl_quantity,wtl_id FROM work_tools_bmci WHERE wtl_owner = '41'";
$resultt = mysqli_query($cdb,$sql);



mysqli_select_db($cdb,"ajax_demo");
$sqlac="SELECT * FROM work_tools_bmci WHERE wtl_owner = '41'";
$resultact = mysqli_query($cdb,$sqlac);

mysqli_select_db($cdb,"ajax_demo");
$sqlord="SELECT * FROM work_tools_bmci WHERE wtl_owner = '41'";
$resultord = mysqli_query($cdb,$sqlord);


mysqli_select_db($cdb,"ajax_demo");
$sqlm="SELECT wmt_name,wmt_quantity FROM work_materials_bmci WHERE wmt_owner = '41'";
$resultm = mysqli_query($cdb,$sqlm);

mysqli_select_db($cdb,"ajax_demo");
$sqlacm="SELECT * FROM work_materials_bmci WHERE wmt_owner = '41'";
$resultactm = mysqli_query($cdb,$sqlacm);

mysqli_select_db($cdb,"ajax_demo");
$sqlordm="SELECT * FROM work_materials_bmci WHERE wmt_owner = '41'";
$resultordm = mysqli_query($cdb,$sqlordm);


mysqli_select_db($cdb,"ajax_demo");
$sqlc="SELECT wch_name,wch_quantity FROM work_chemicals_bmci WHERE wch_owner = '41'";
$resultc = mysqli_query($cdb,$sqlc);

mysqli_select_db($cdb,"ajax_demo");
$sqlacc="SELECT * FROM work_chemicals_bmci WHERE wch_owner = '41'";
$resultactc = mysqli_query($cdb,$sqlacc);

mysqli_select_db($cdb,"ajax_demo");
$sqlordc="SELECT * FROM work_chemicals_bmci WHERE wch_owner = '41'";
$resultordc = mysqli_query($cdb,$sqlordc);



mysqli_select_db($cdb,"ajax_demo");
$sqlp="SELECT wppe_name,wppe_quantity FROM work_ppe_bmci WHERE wppe_owner = '41'";
$resultp = mysqli_query($cdb,$sqlp);

mysqli_select_db($cdb,"ajax_demo");
$sqlacp="SELECT * FROM work_ppe_bmci WHERE wppe_owner = '41'";
$resultactp = mysqli_query($cdb,$sqlacp);

mysqli_select_db($cdb,"ajax_demo");
$sqlordp="SELECT * FROM work_ppe_bmci WHERE wppe_owner = '41'";
$resultordp = mysqli_query($cdb,$sqlordp);



mysqli_select_db($cdb,"ajax_demo");
$sqla="SELECT wape_name,wape_quantity FROM work_ape_bmci WHERE wape_owner = '41'";
$resulta = mysqli_query($cdb,$sqla);

mysqli_select_db($cdb,"ajax_demo");
$sqlaca="SELECT * FROM work_ape_bmci WHERE wape_owner = '41'";
$resultacta = mysqli_query($cdb,$sqlaca);

mysqli_select_db($cdb,"ajax_demo");
$sqlorda="SELECT * FROM work_ape_bmci WHERE wape_owner = '41'";
...
?>
	...
	<?php
	require('controls/zdfzfzef/de5.php');
$cntasrf=$cdb->prepare("SELECT count(str_owner) FROM srf_tools_request WHERE str_owner='41' AND str_status='approved'");
$cntasrf->execute();
...
$cntsrf=$cdb->prepare("SELECT count(str_owner) FROM srf_tools_request WHERE str_owner='41'");
$cntsrf->execute();
...
<style>
								...
								<tbody>
									<tr>
											...
											<span><?php echo $rowt['wtl_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#toolsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->

												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalbmci"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalbmci"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a> 
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalbmci"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalbmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
						...
						<div class="multi-collapse collapse" id="multiCollapsetools" style="">
							<div class="card card-body">
											...
											?>
												...
												?>
												<?php echo $rowact[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinebmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowact[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinebmci"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php }
												?>
												<?php
   ...
   <!--<div class="header">
	...
	<!---->
												 ...
												 <!--<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper" data-toggle="modal" data-target="#materialsmodalbmci">Details</button>
										...
										<tr>
											...
											<span><?php echo $rowmt['wmt_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#materialsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->

												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalbmci"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalbmci"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a> 
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalbmci"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalbmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactm[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinebmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactm[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinebmci"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
   ...
   <!--<div class="header">
	...
	<!---->
										...
										<tr>
											...
											<span><?php echo $rowc['wch_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalbmci"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalbmci"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowc['wch_quantity']>5 && $rowc['wch_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalbmci"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowc['wch_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a>--> 
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalbmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
																</div>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactc[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinebmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactc[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinebmci"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
   ...
   <!--<div class="header">
	...
	<!---->
										...
										<tr>
											...
											<span><?php echo $rowp['wppe_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalbmci"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												 if ($rowp['wppe_quantity']<=5 && $rowp['wppe_quantity']>=2) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalbmci"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowp['wppe_quantity']>5 && $rowp['wppe_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a>--> 
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalbmci"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowp['wppe_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalbmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
																</div>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactp[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinebmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactp[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinebmci"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
	...
	<!---->
										...
										<?php
											...
											<span><?php echo $rowa['wape_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalbmci"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												 if ($rowa['wape_quantity']<=5 && $rowa['wape_quantity']>=2) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalbmci"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowa['wape_quantity']>5 && $rowa['wape_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalbmci"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowa['wape_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalbmci"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalbmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</a></span>
											<?php }  ?>
																</div>
									...
									while($roworda = mysqli_fetch_row($resultorda)) {
										...
										<?php if ($roworda[6]<=1) {
											...
											?>
												...
												?>
												<?php echo $rowacta[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinebmci"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowacta[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinebmci"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br>
...
<div class="modal fade" id="materialsmodalbmci" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
															...
															<div class="kt-portlet__body">
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<?php include('controls/bmci/tools/detailst.php')?>
																	</div>
																</div>
															</div>
														</div>
...
<div class="modal fade bd-example-modal-sm" id="tooldefinebmci" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
															...
															<div class="kt-portlet__body">
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<?php include('controls/bmci/tools/define.php')?>
																	</div>
																</div>
															</div>
														</div>
...
<div class="modal fade bd-example-modal-sm" id="matdefinebmci" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
															...
															<div class="kt-portlet__body">
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<?php include('controls/bmci/mats/define.php')?>
																	</div>
																</div>
															</div>
														</div>
															...
															<div class="kt-portlet__body">
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<?php include('controls/bmci/srf.php')?>
																	</div>
																</div>
															</div>
														</div>
