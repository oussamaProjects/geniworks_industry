...
$sqlct="SELECT count(wtl_name) FROM work_tools_apm2 WHERE wtl_owner = '11'";
$resultct = mysqli_query($cdb,$sqlct);

mysqli_select_db($cdb,"ajax_demo");
$sqlcm="SELECT count(wmt_name) FROM work_materials_apm2 WHERE wmt_owner = '11'";
$resultcm = mysqli_query($cdb,$sqlcm);

mysqli_select_db($cdb,"ajax_demo");
$sqlcc="SELECT count(wch_name) FROM work_chemicals_apm2 WHERE wch_owner = '11'";
$resultcc = mysqli_query($cdb,$sqlcc);

mysqli_select_db($cdb,"ajax_demo");
$sqlca="SELECT count(wape_name) FROM work_ape_apm2 WHERE wape_owner = '11'";
$resultca = mysqli_query($cdb,$sqlca);

mysqli_select_db($cdb,"ajax_demo");
$sqlcp="SELECT count(wppe_name) FROM work_ppe_apm2 WHERE wppe_owner = '11'";
$resultcp = mysqli_query($cdb,$sqlcp);



mysqli_select_db($cdb,"ajax_demo");
$sql="SELECT wtl_name,wtl_quantity,wtl_standard,wtl_id FROM work_tools_apm2 WHERE wtl_owner = '11'";
$resultt = mysqli_query($cdb,$sql);



mysqli_select_db($cdb,"ajax_demo");
$sqlac="SELECT * FROM work_tools_apm2 WHERE wtl_owner = '11'";
$resultact = mysqli_query($cdb,$sqlac);

mysqli_select_db($cdb,"ajax_demo");
$sqlord="SELECT * FROM work_tools_apm2 WHERE wtl_owner = '11'";
$resultord = mysqli_query($cdb,$sqlord);


mysqli_select_db($cdb,"ajax_demo");
$sqlm="SELECT wmt_name,wmt_standard,wmt_quantity FROM work_materials_apm2 WHERE wmt_owner = '11'";
$resultm = mysqli_query($cdb,$sqlm);

mysqli_select_db($cdb,"ajax_demo");
$sqlacm="SELECT * FROM work_materials_apm2 WHERE wmt_owner = '11'";
$resultactm = mysqli_query($cdb,$sqlacm);

mysqli_select_db($cdb,"ajax_demo");
$sqlordm="SELECT * FROM work_materials_apm2 WHERE wmt_owner = '11'";
$resultordm = mysqli_query($cdb,$sqlordm);


mysqli_select_db($cdb,"ajax_demo");
$sqlc="SELECT wch_name,wch_standard,wch_quantity FROM work_chemicals_apm2 WHERE wch_owner = '11'";
$resultc = mysqli_query($cdb,$sqlc);

mysqli_select_db($cdb,"ajax_demo");
$sqlacc="SELECT * FROM work_chemicals_apm2 WHERE wch_owner = '11'";
$resultactc = mysqli_query($cdb,$sqlacc);

mysqli_select_db($cdb,"ajax_demo");
$sqlordc="SELECT * FROM work_chemicals_apm2 WHERE wch_owner = '11'";
$resultordc = mysqli_query($cdb,$sqlordc);



mysqli_select_db($cdb,"ajax_demo");
$sqlp="SELECT wppe_name,wppe_standard,wppe_quantity FROM work_ppe_apm2 WHERE wppe_owner = '11'";
$resultp = mysqli_query($cdb,$sqlp);

mysqli_select_db($cdb,"ajax_demo");
$sqlacp="SELECT * FROM work_ppe_apm2 WHERE wppe_owner = '11'";
$resultactp = mysqli_query($cdb,$sqlacp);

mysqli_select_db($cdb,"ajax_demo");
$sqlordp="SELECT * FROM work_ppe_apm2 WHERE wppe_owner = '11'";
$resultordp = mysqli_query($cdb,$sqlordp);



mysqli_select_db($cdb,"ajax_demo");
$sqla="SELECT wape_name,wape_standard,wape_quantity FROM work_ape_apm2 WHERE wape_owner = '11'";
$resulta = mysqli_query($cdb,$sqla);

mysqli_select_db($cdb,"ajax_demo");
$sqlaca="SELECT * FROM work_ape_apm2 WHERE wape_owner = '11'";
$resultacta = mysqli_query($cdb,$sqlaca);

mysqli_select_db($cdb,"ajax_demo");
$sqlorda="SELECT * FROM work_ape_apm2 WHERE wape_owner = '11'";
  ...
  <div class="kt-section__content kt-section__content--border">
                      ...
                      ?>
                        ...
                        ?>
                         ...
                         <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeppl" data-book-id="my_id_value"><?php echo $rowordp[2];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowordp[7]-$rowordp[6])>=1 && ($rowordp[7]-$rowordp[6])<=2) {
                        ?> 
                        <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeppl" data-book-id="my_id_value"><?php echo $rowordp[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                ...
                <div class="tab-pane active" id="multiCollapseape1" role="tabpanel">
                  ...
                  while($roworda = mysqli_fetch_row($resultorda)) {
                    ...
                    <?php if (($roworda[7]-$roworda[6])>=3) {
                      ?>
                      <?php echo $roworda[2];?>
                        <a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeppl"><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <br>
                        <?php
                      }
                        ...
                        <?php echo $roworda[2];?>
                        <a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeppl" ><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        </br>
