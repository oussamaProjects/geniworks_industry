...
$showsrf=$cdb->prepare("SELECT * FROM srf_tools_request WHERE str_owner='12' AND str_status='not approved'");
$showsrf->execute();
if ($showsrf===false) {
...
$findtool=$cdb->prepare("SELECT * FROM work_tools_apm2 WHERE wtl_internal_id='".$showsrf[2]."'");
$findtool->execute();
if ($findtool===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
