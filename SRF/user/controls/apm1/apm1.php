...
$sqlct="SELECT count(wtl_name) FROM work_tools WHERE wtl_owner = '11'";
$resultct = mysqli_query($cdb,$sqlct);

mysqli_select_db($cdb,"ajax_demo");
$sqlcm="SELECT count(wmt_name) FROM work_materials WHERE wmt_owner = '11'";
$resultcm = mysqli_query($cdb,$sqlcm);

mysqli_select_db($cdb,"ajax_demo");
$sqlcc="SELECT count(wch_name) FROM work_chemicals WHERE wch_owner = '11'";
$resultcc = mysqli_query($cdb,$sqlcc);

mysqli_select_db($cdb,"ajax_demo");
$sqlca="SELECT count(wape_name) FROM work_ape WHERE wape_owner = '11'";
$resultca = mysqli_query($cdb,$sqlca);

mysqli_select_db($cdb,"ajax_demo");
$sqlcp="SELECT count(wppe_name) FROM work_ppe WHERE wppe_owner = '11'";
$resultcp = mysqli_query($cdb,$sqlcp);



mysqli_select_db($cdb,"ajax_demo");
$sql="SELECT wtl_name,wtl_quantity,wtl_id FROM work_tools WHERE wtl_owner = '11'";
$resultt = mysqli_query($cdb,$sql);

mysqli_select_db($cdb,"ajax_demo");
$sqlm="SELECT wmt_name,wmt_quantity FROM work_materials WHERE wmt_owner = '11'";
$resultm = mysqli_query($cdb,$sqlm);

mysqli_select_db($cdb,"ajax_demo");
$sqlc="SELECT wch_name,wch_quantity FROM work_chemicals WHERE wch_owner = '11'";
$resultc = mysqli_query($cdb,$sqlc);

mysqli_select_db($cdb,"ajax_demo");
$sqlp="SELECT wppe_name,wppe_quantity FROM work_ppe WHERE wppe_owner = '11'";
$resultp = mysqli_query($cdb,$sqlp);

mysqli_select_db($cdb,"ajax_demo");
$sqla="SELECT wape_name,wape_quantity FROM work_ape WHERE wape_owner = '11'";
