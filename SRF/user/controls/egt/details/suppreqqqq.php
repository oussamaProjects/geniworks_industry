...
require('../zdfzfzef/de5.php');
  ...
  $supp1=$_POST['supp1t2'];
$toolid11=$_POST['toolid111'];
$suppid11=$_POST['suppid11'];
$addcomment=$_POST['addcommentt12'];
$paymmt=$_POST['paymmtt12'];
...
if(isset($checkr))
{
	...
	$addreq = "INSERT INTO srf_tools_request VALUES ('', '$toolid11$suppid11', '" . $toolid11 . "', '" . $supp1 . "', '12', '" . $suppid11 . "', NOW(), 'not approved', '$paymmt', '$addcomment')";
