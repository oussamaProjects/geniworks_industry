                  ...
                  <div class="row">
                        ...
                        <div class="kt-portlet__body kt-portlet__body--fit">
                          <ul class="kt-nav kt-nav--bold kt-nav--md-space kt-nav--v3 kt-margin-t-20 kt-margin-b-20 nav nav-tabs" role="tablist">
                            <li class="kt-nav__item">
                              <a class="kt-nav__link active" data-toggle="tab" href="#egttools" role="tab">
                            ...
                            <li class="kt-nav__item">
                              <a class="kt-nav__link" data-toggle="tab" href="#egtmaterials" role="tab">
                                <span class="kt-nav__link-icon"><i class="flaticon2-soft-icons-1"></i></span>
                                <span class="kt-nav__link-text">Materials</span>
                              </a>
                            </li>
                            <li class="kt-nav__item">
                              <a class="kt-nav__link" data-toggle="tab" href="#egtchemicals" role="tab">
                                <span class="kt-nav__link-icon"><i class="flaticon2-soft-icons-1"></i></span>
                                <span class="kt-nav__link-text">Chemicals</span>
                              </a>
                            </li>
                            <li class="kt-nav__item">
                              <a class="kt-nav__link" data-toggle="tab" href="#egtppe" role="tab">
                                <span class="kt-nav__link-icon"><i class="flaticon2-soft-icons-1"></i></span>
                                <span class="kt-nav__link-text">PPE</span>
                              </a>
                            </li>
                            <li class="kt-nav__item">
                              <a class="kt-nav__link" data-toggle="tab" href="#egtape" role="tab">
                                <span class="kt-nav__link-icon"><i class="flaticon2-soft-icons-1"></i></span>
                    ...
                    <div class="col-lg-8 col-xl-9">
                      <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="egttools" role="tabpanel">
                          <div class="kt-portlet">
                            <div class="kt-portlet__head">
                              <div class="kt-portlet__head-label">
                      ...
                      <span> 
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalegt"><?php echo $rowt['wtl_name'];?><img src="../img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalegt"><?php echo $rowt['wtl_name'];?><img src="../img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a> 
                        <?php 
                        }
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalegt"><?php echo $rowt['wtl_name'];?><img src="../img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      ...
                      <td>
                        ...
                        <div class="tab-pane fade" id="egtmaterials" role="tabpanel">
                          <div class="kt-portlet">
                            <div class="kt-portlet__head">
                              <div class="kt-portlet__head-label">
                      ...
                      <span> 
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalegt"><?php echo $rowmt['wmt_name'];?><img src="../img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalegt"><?php echo $rowmt['wmt_name'];?><img src="../img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a> 
                        <?php 
                        }
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodalegt"><?php echo $rowmt['wmt_name'];?><img src="../img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      <?php }  ?>
                        ...
                        <div class="tab-pane fade" id="egtppe" role="tabpanel">
                          <div class="kt-portlet">
                            <div class="kt-portlet__head">
                              <div class="kt-portlet__head-label">
                      ...
                      <span>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalegt"><?php echo $rowp['wppe_name'];?><img src="../img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowp['wppe_standard']-$rowp['wppe_quantity'])>=1 && ($rowp['wppe_standard']-$rowp['wppe_quantity'])<=2) {
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href=""  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalegt"><?php echo $rowp['wppe_name'];?><img src="../img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        <?php 
                        }
                        ...
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodalegt"><?php echo $rowp['wppe_name'];?><img src="../img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      <?php }  ?>
                                </div>
                        ...
                        <div class="tab-pane fade" id="egtchemicals" role="tabpanel">
                          <div class="kt-portlet">
                            <div class="kt-portlet__head">
                              <div class="kt-portlet__head-label">
                      ...
                      <?php if (($rowc['wch_standard']-$rowc['wch_quantity'])>=3) {
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalegt"><?php echo $rowc['wch_name'];?><img src="../img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                        ...
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalegt"><?php echo $rowc['wch_name'];?><img src="../img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        <?php 
                        }
                        ...
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a>--> 
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodalegt"><?php echo $rowc['wch_name'];?><img src="../img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      <?php }  ?>
                                </div>
                    ...
                    <?php
                      ...
                      <span>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalegt"><?php echo $rowa['wape_name'];?> <img src="../img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowa['wape_standard']-$rowa['wape_quantity'])>=1 && ($rowa['wape_standard']-$rowa['wape_quantity'])<=2) {
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalegt"><?php echo $rowa['wape_name'];?> <img src="../img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        <?php 
                        }
                        ...
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalapm1"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalegt"><?php echo $rowa['wape_name'];?> <img src="../img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </a></span>
                      <?php }  ?>
                                </div>
...
<div class="modal fade bd-example-modal-xl" id="chemicalsmodalapm1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <?php // include('controls/egt/details/detailsc.php')?>
                          </div>
<div class="modal fade bd-example-modal-xl" id="ppemodalapm1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <?php // include('controls/egt/details/detailsp.php')?>
                          </div>
<div class="modal fade bd-example-modal-xl" id="apemodalapm1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <?php // include('controls/egt/details/detailsa.php')?>
                          </div> -->




<div class="modal fade bd-example-modal-sm" id="toolsinsmodalegt" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/egt/showtools.php');?>
...
<div class="modal fade bd-example-modal-sm" id="matsinsmodalegt" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/egt/showmat.php');?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="cheminsmodalegt" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/egt/showchemicals.php');?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="ppeinsmodalegt" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/egt/showppe.php');?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="apeinsmodalegt" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/egt/showape.php');?>
                                  </div>
                                </div>
                              </div>
                            </div>
