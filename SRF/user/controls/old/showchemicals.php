...
$showr=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='apm1'");
$showr->execute();
if ($showr===false) {
...
require('zdfzfzef/de5.php');
$showr2=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='apm2'");
$showr2->execute();
if ($showr2===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="el-card-avatar el-overlay-1"> <img width="50" src="../../imgs/chemicals/<?php echo $showrow2[3];?>" alt="user"> 
                                                    </div>
...
require('zdfzfzef/de5.php');
$showr3=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='eurogate'");
$showr3->execute();
if ($showr3===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="el-card-avatar el-overlay-1"> <img width="50" src="../../imgs/chemicals/<?php echo $showrow3[3];?>" alt="user"> 
                                                    </div>
...
require('zdfzfzef/de5.php');
$showr4=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='de'");
$showr4->execute();
if ($showr4===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="el-card-avatar el-overlay-1"> <img width="50" src="../../imgs/chemicals/<?php echo $showrow4[3];?>" alt="user"> 
                                                    </div>
...
require('zdfzfzef/de5.php');
$showr5=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='tc3'");
$showr5->execute();
if ($showr5===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="el-card-avatar el-overlay-1"> <img width="50" src="../../imgs/chemicals/<?php echo $showrow5[3];?>" alt="user"> 
                                                    </div>
...
require('zdfzfzef/de5.php');
$showr6=$cdb->prepare("SELECT * FROM work_chemicals WHERE wch_owner='bmci'");
$showr6->execute();
if ($showr6===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
                                        ...
                                        <tbody>
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="el-card-avatar el-overlay-1"> <img width="50" src="../../imgs/chemicals/<?php echo $showrow6[3];?>" alt="user"> 
                                                    </div>
