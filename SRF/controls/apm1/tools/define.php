...
?>
                     ...
                     <div class="kt-portlet__body">
                      ...
                      <div id="kt-widget-slider-14-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
                        ...
                        <div class="carousel-inner"> 
                          ...
                          <form class="toolsdefapm11<?php echo  "$showrow2[1]";?>" method="post">
                              ...
                              <div class="kt-widget-14__data">
                                    ...
                                    <div class="number-input">
                                        <div class="custom-quantity-input">
                                         ...
                                         <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          ...
                                          <input min="0" readonly value="<?php echo ($showrow2[6]);?>" style=" color: #5578eb; " name="actualapm1" type="number">
                                ...
                                <div class="kt-widget-14__info" style="background-color: transparent;">
                                  <div class="kt-widget-14__info-title">
                                    ...
                                    <input  class="kt-widget-14__info-title" min="0" readonly="readonly" value="<?php echo ($showrow2[7]);?>" style="background-color: transparent; width: 20px; text-align: center; border:0px transparent;" name="standardapm1">
                                ...
                                <div class="kt-widget-14__info" style="background-color: transparent;">
                                    ...
                                    <input type="hidden" value="<?php echo  "$showrow2[1]";?>" name="tidapm1">
 ...
 <script>
      $(function () {
        ...
        $('.toolsdefapm11<?php echo  "$showrow2[1]";?>').on('submit', function (e) {
          ...
          $.ajax({
            ...
            data: $('.toolsdefapm11<?php echo  "$showrow2[1]";?>').serialize(),
            success: function () {
            alert('good dude');
            }
          });
    ...
    <script>
   (function() {
const button = document.querySelector('.btton<?php echo  "$showrow2[1]";?>');
const submit = document.querySelector('.sbmit<?php echo  "$showrow2[1]";?>');

function toggleClass() {
  this.classList.toggle('activee<?php echo  "$showrow2[1]";?>');
}

function addClass() {
  this.classList.add('finishedd<?php echo  "$showrow2[1]";?>');
}
...
.btton<?php echo  "$showrow2[1]";?>:before {
  position: absolute;
  content: '';
  bottom: 0;
  left: 0;
...
.btton<?php echo  "$showrow2[1]";?> span {
  position: absolute;
  line-height: 0;
}
.btton<?php echo  "$showrow2[1]";?> span i {
  transform-origin: center center;
}
.btton<?php echo  "$showrow2[1]";?> span:nth-of-type(1) {
  top: 50%;
  transform: translateY(-50%);
}
.btton<?php echo  "$showrow2[1]";?> span:nth-of-type(2) {
  top: 100%;
  transform: translateY(0%);
  font-size: 18px;
}
.btton<?php echo  "$showrow2[1]";?> span:nth-of-type(3) {
  display: none;
}


.activee<?php echo  "$showrow2[1]";?>:before {
  width: 100%;
  transition: width 3s linear;
}
.activee<?php echo  "$showrow2[1]";?> span:nth-of-type(1) {
  top: -100%;
  transform: translateY(-50%);
}
.activee<?php echo  "$showrow2[1]";?> span:nth-of-type(2) {
  top: 50%;
  transform: translateY(-50%);
}
.activee<?php echo  "$showrow2[1]";?> span:nth-of-type(2) i {
  animation: loading 500ms linear infinite;
}
.activee<?php echo  "$showrow2[1]";?> span:nth-of-type(3) {
  display: none;
}

.finishedd<?php echo  "$showrow2[1]";?>{
  background-color: #54d98c;
}
.finishedd<?php echo  "$showrow2[1]";?> .sbmit<?php echo  "$showrow2[1]";?> {
  display: none;
}
.finishedd<?php echo  "$showrow2[1]";?> .loadinng<?php echo  "$showrow2[1]";?> {
  display: none;
}
.finishedd<?php echo  "$showrow2[1]";?> .checkk<?php echo  "$showrow2[1]";?> {
  display: block !important;
  font-size: 24px;
  animation: scale 0.5s linear;
}
.finishedd<?php echo  "$showrow2[1]";?> .checkk<?php echo  "$showrow2[1]";?> i {
  transform-origin: center center;
}
...
$(document).ready(function(){
  $(".quantity-input-up").click(function(){
    var inpt = $(this).parents(".custom-quantity-input").find("[name=actualapm1]");
  ...
  $(".standard-input-up").click(function(){
    var inpt = $(this).parents(".custom-standard-input").find("[name=standardapm1]");
    var val = parseInt(inpt.val());
    if ( val < 0 ) inpt.val(val=0);
    inpt.val(val+1);
