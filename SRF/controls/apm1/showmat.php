                                    ...
                                    <div class="number-input">
                                      <div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          ...
                                          <input min="0" onChange="myNewFunction(this)" id="actualapm1" value="<?php echo  "$showrow2[6]";?>" style=" color: #fd397a; " name="quantity5" type="number">
...
<script>
      $(function () {
        ...
        $('.matforma11<?php echo  "$showrow2[1]";?>').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/mats/updategaps5.php',
                                  ...
                                  <div class="kt-widget-14__info-title">
                                    <div class="number-input">
                                      <div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          <i class="fa fa-plus"></i></a>
                                          <input min="0" onChange="myNewFunction(this)" id="actualapm1" value="<?php echo  "$showrow2[6]";?>" style=" color: #ffb822; " name="quantity4" type="number">
...
<script>
      $(function () {
        ...
        $('.matforma12<?php echo  "$showrow2[1]";?>').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/mats/updategaps.php',
                                  ...
                                  <div class="kt-widget-14__info-title">
                                    <div class="number-input">
                                      <div class="kt-widget-14__desc">
                                        <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          <i class="fa fa-plus"></i></a>
                                          <input min="0" onChange="myNewFunction(this)" id="actualapm1" value="<?php echo  "$showrow2[6]";?>" style=" color: #1dc9b7; " name="quantity7" type="number">
...
<script>
      $(function () {
        ...
        $('.matforma14<?php echo  "$showrow2[1]";?>').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/mats/updategaps7.php',
