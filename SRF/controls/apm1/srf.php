...
$findtool=$cdb->prepare("SELECT * FROM work_tools_apm1 WHERE wtl_internal_id='".$showsrf[2]."'");
$findtool->execute();
if ($findtool===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
  ...
  $resfind=$findtool->get_result();
                                          ...
                                          ?><?php while ($showf=$resfind->fetch_row()) { ?>
                                          	<form id="approveorderapm1tools<?php echo $showsrf[0];?>">
												<div class="kt-widget-17__item">
													...
													<input type="hidden" name="apridapm1tool" value="<?php echo $showsrf[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
...
<script>
      $(function () {
        ...
        $('#approveorderapm1tools<?php echo $showsrf[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/apm1/tools/approvesingle.php',
            data: $('#approveorderapm1tools<?php echo $showsrf[0];?>').serialize(),
            success: function () {
...
$showsrfm=$cdb->prepare("SELECT * FROM srf_materials_request WHERE str_owner='11' AND str_status='not approved'");
...
$findmat=$cdb->prepare("SELECT * FROM work_materials_apm1 WHERE wmt_internal_id='".$showsrfm[2]."'");
...
if ($findmat===false) {
  ...
  $resfindm=$findmat->get_result();
                                          ...
                                          ?><?php while ($showfm=$resfindm->fetch_row()) { ?>
                                          	<form id="approveorderapm1mats<?php echo $showsrfm[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridapm1mats" value="<?php echo $showsrfm[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveorderapm1mats<?php echo $showsrfm[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/apm1/mats/approvesingle.php',
            data: $('#approveorderapm1mats<?php echo $showsrfm[0];?>').serialize(),
            success: function () {
      ...
      $(function () {
        ...
        $('#approvesrfdm').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/mats/approve.php',
...
<?php  }
$showsrfc=$cdb->prepare("SELECT * FROM srf_chemicals_request WHERE str_owner='11' AND str_status='not approved'");
$showsrfc->execute();
if ($showsrfc===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findchem=$cdb->prepare("SELECT * FROM work_chemicals_apm1 WHERE wch_internal_id='".$showsrfc[2]."'");
...
if ($findchem===false) {
  ...
  $resfindc=$findchem->get_result();
                                          ...
                                          ?><?php while ($showfc=$resfindc->fetch_row()) { ?>
											<form id="approveorderapm1chems<?php echo $showsrfc[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridapm1chems" value="<?php echo $showsrfc[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveorderapm1chems<?php echo $showsrfc[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/apm1/chems/approvesingle.php',
            data: $('#approveorderapm1chems<?php echo $showsrfc[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
      ...
      $(function () {
        ...
        $('#approvesrfdc').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/chems/approve.php',
...
$showsrfp=$cdb->prepare("SELECT * FROM srf_ppe_request WHERE str_owner='11' AND str_status='not approved'");
$showsrfp->execute();
if ($showsrfp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findppe=$cdb->prepare("SELECT * FROM work_ppe_apm1 WHERE wppe_internal_id='".$showsrfp[2]."'");
...
if ($findppe===false) {
  ...
  $resfindp=$findppe->get_result();
                                          ...
                                          ?><?php while ($showfp=$resfindp->fetch_row()) { ?>
											<form id="approveorderapm1ppe<?php echo $showsrfp[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridapm1ppe" value="<?php echo $showsrfp[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveorderapm1ppe<?php echo $showsrfp[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/apm1/ppe/approvesingle.php',
            data: $('#approveorderapm1ppe<?php echo $showsrfp[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
      ...
      $(function () {
        ...
        $('#approvesrfdp').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/ppe/approve.php',
...
$showsrfa=$cdb->prepare("SELECT * FROM srf_ape_request WHERE str_owner='11' AND str_status='not approved'");
$showsrfa->execute();
if ($showsrfa===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findape=$cdb->prepare("SELECT * FROM work_ape_apm1 WHERE wape_internal_id='".$showsrfa[2]."'");
...
if ($findape===false) {
  ...
  $resfinda=$findape->get_result();
                                          ...
                                          ?><?php while ($showfa=$resfinda->fetch_row()) { ?>
												<form id="approveorderapm1ape<?php echo $showsrfa[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridapm1ape" value="<?php echo $showsrfa[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveorderapm1ape<?php echo $showsrfa[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/apm1/ape/approvesingle.php',
            data: $('#approveorderapm1ape<?php echo $showsrfa[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
...
<script>
      $(function () {
        ...
        $('#approvesrfda').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/apm1/ape/approve.php',
