                      ...
                      <div id="kt-widget-slider-14-2" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
                        <div class="kt-slider__head">
                          ...
                          <div class="carousel-inner">
                            <form class="chemsup11<?php echo "$rowsup[0]";?>">
                      ...
                      <div class="custom-suppc-input">
                       ...
                       <a class="supp-btn suppc-input-down btn btn-outline-hover-danger btn-sm btn-icon"><i class="fa fa-minus"></i></a>
                              ...
                              <div class="kt-widget-15__foot-toolbar">
                                <input type="hidden" value="<?php echo $rowsup[1];?>" name="chemid1c">
                                <input type="hidden" value="<?php echo $rowsup[5];?>" >
                                <div class="kt-widget-15__desc">
                                    Additional Informations
                                  </div>
                                <textarea name="addcommentc"></textarea>
                                <button class="button-de2c<?php echo "$rowsup[0]";?> pulse-button">
  <span style="font-weight: 900;" class="submit-de2c<?php echo "$rowsup[0]";?>">Save</span>
  <span class="loading-de2c<?php echo "$rowsup[0]";?>"><i class="fa fa-refresh"></i></span>
  <span class="check-de2c<?php echo "$rowsup[0]";?>"><i class="fa fa-check"></i></span>
</button>
                      ...
                      <script>
   (function() {
const button = document.querySelector('.button-de2c<?php echo "$rowsup[0]";?>');
const submit = document.querySelector('.submit-de2c<?php echo "$rowsup[0]";?>');
...
.button-de2c<?php echo "$rowsup[0]";?>:before {
  position: absolute;
  content: '';
  bottom: 0;
  left: 0;
...
.button-de2c<?php echo "$rowsup[0]";?> span {
  position: absolute;
  line-height: 0;
}
.button-de2c<?php echo "$rowsup[0]";?> span i {
  transform-origin: center center;
}
.button-de2c<?php echo "$rowsup[0]";?> span:nth-of-type(1) {
  top: 50%;
  transform: translateY(-50%);
}
.button-de2c<?php echo "$rowsup[0]";?> span:nth-of-type(2) {
  top: 100%;
  transform: translateY(0%);
  font-size: 18px;
}
.button-de2c<?php echo "$rowsup[0]";?> span:nth-of-type(3) {
  display: none;
}
...
.finished-de2c<?php echo "$rowsup[0]";?> .submit-de2c<?php echo "$rowsup[0]";?> {
  display: none;
}
.finished-de2c<?php echo "$rowsup[0]";?> .loading-de2c<?php echo "$rowsup[0]";?> {
  display: none;
}
.finished-de2c<?php echo "$rowsup[0]";?> .check-de2c<?php echo "$rowsup[0]";?> {
  display: block !important;
  font-size: 24px;
  animation: scale 0.5s linear;
}
.finished-de2c<?php echo "$rowsup[0]";?> .check-de2c<?php echo "$rowsup[0]";?> i {
  transform-origin: center center;
}
    ...
    transform: scale(1);
     ...
     <script>
      $(function () {
        ...
        $('.chemsup11<?php echo  "$rowsup[0]";?>').on('submit', function (e) {
          ...
          $.ajax({
            ...
            data: $('.chemsup11<?php echo  "$rowsup[0]";?>').serialize(),
            success: function () {
