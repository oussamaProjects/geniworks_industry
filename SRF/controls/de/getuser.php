                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-xl-4">
                      <div class="kt-profile__contact" style="align-content: center;">
                        ...
                        <br>
                        <br>
                        <a href="pdf/invoice31.php" target="_blank" class="kt-profile__contact-item" >
  <?php
  require('controls/zdfzfzef/de5.php');
...
if ($cntasrf===false) {
  ...
  while ($rowasrf=$reasrf->fetch_row()) {
                        ...
                        <a href="#" class="kt-profile__contact-item"  data-toggle="modal" data-target="#srboardd">
<?php require('controls/zdfzfzef/de5.php');
$cntsrf=$cdb->prepare("SELECT count(str_owner) FROM srf_tools_request WHERE str_owner='31' AND str_status='not approved'");
$cntsrf->execute();
...
<style>
                  ...
                  <tr>
                      <td style="width: 40%; vertical-align: middle;">
                        <div class="kt-section__content kt-section__content--border">
                          <p>
                            <a class="" data-toggle="collapse" href="#multiCollapsetoolsde" role="button" aria-expanded="true" aria-controls="multiCollapsetoolsde"><h5>Tools  <i class="la la-ellipsis-v"></i></h5></a>
                          </p>
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapsetoolsde" style="">
                      ...
                      <span> 
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalde"><?php echo $rowt['wtl_name'];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalde"><?php echo $rowt['wtl_name'];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a> 
                        <?php 
                        }
                        ...
                        <a style="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodalde"><?php echo $rowt['wtl_name'];?><img src="img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
  ...
  <div class="kt-section__content kt-section__content--border">
                          <p>
                            ...
                            <a class="" data-toggle="collapse" href="#multiCollapsetoolsde" role="button" aria-expanded="true" aria-controls="multiCollapsetoolsde"><h3> <i class="la la-tasks"></i></h3></a>
                      ...
                      <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" data-toggle="tab" href="#multiCollapsetoolsdes1">Order</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsetoolsdes2">Define</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsetoolsdes3">Reports</a>
                        </li>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="multiCollapsetoolsdes1" role="tabpanel">
                        <div class="card card-body">
                      ...
                      ?>
                        ...
                        <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsppdl"><?php echo $roword[2];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></i></a>
                      ...
                      <?php
                        ...
                        <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsppdl" ><?php echo $roword[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                      ...
                      <?php  }  ?>
                        ...
                        <div class="tab-pane" id="multiCollapsetoolsdes2" role="tabpanel">
                      ...
                      ?>
                        ...
                        ?>
                        <?php echo $rowact[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinede"><i style="font-size:20px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

                        <br>
                        <?php
                      }else{
                        ?>
                        <?php echo $rowact[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinede"><i style="font-size:20px; color:#5578eb;" class="la la-cogs"></i></a>
                        <br>
                        <?php } } 
                         ?>
                         <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
                        </div>
                        <div class="tab-pane" id="multiCollapsetoolsdes3" role="tabpanel">
  ...
  <!---->
                    ...
                    <tr>
                      <td style="width: 40%; vertical-align: middle;">
                        <div class="kt-section__content kt-section__content--border">
                          <p>
                            <a class="" data-toggle="collapse" href="#multiCollapsematde" role="button" aria-expanded="true" aria-controls="multiCollapsematde"><h5>Materials  <i class="la la-ellipsis-v"></i></h5></a>
                            
                            
                          </p>
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapsematde">
                                <div class="card card-body">
                      ...
                      <span> 
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaldea"><?php echo $rowmt['wmt_name'];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaldea"><?php echo $rowmt['wmt_name'];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a> 
                        <?php 
                        }
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaldea"><?php echo $rowmt['wmt_name'];?><img src="img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      <?php }  ?>
  ...
  <div class="kt-section__content kt-section__content--border">
                          <p>
                            ...
                            <a class="" data-toggle="collapse" href="#multiCollapsematde" role="button" aria-expanded="true" aria-controls="multiCollapsematde"><h3> <i class="la la-tasks"></i></h3></a>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapsematde" style="">
                                <div class="card card-body">
                      ...
                      <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" data-toggle="tab" href="#multiCollapsematdes1">Order</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsematdes2">Define</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsematdes3">Reports</a>
                        </li>
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">More</a>
                          <div class="dropdown-menu">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="multiCollapsematdes1" role="tabpanel">
                        <div class="card card-body">
                      ...
                      ?>
                        ...
                        <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsdeol"><?php echo $rowordm[2];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></i></a>
                      ...
                      <?php
                        ...
                        <a  href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsdeol" ><?php echo $rowordm[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                      ...
                      <?php  }  ?>
                        ...
                        <div class="tab-pane" id="multiCollapsematdes2" role="tabpanel">
                      ...
                      ?>
                        ...
                        ?>
                        <?php echo $rowactm[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinede"><i style="font-size:20px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

                        <br>
                        <?php
                      }else{
                        ?>
                        <?php echo $rowactm[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinede"><i style="font-size:20px; color:#5578eb;" class="la la-cogs"></i></a>
                        <br>
                        <?php } } 
                         ?>
                         <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
                        </div>
                        <div class="tab-pane" id="multiCollapsematdes3" role="tabpanel">
  ...
  <!---->
                    ...
                    <tr>
                      <td style="width: 40%; vertical-align: middle;">
                        <div class="kt-section__content kt-section__content--border">
                          <p>
                            <a class="" data-toggle="collapse" href="#multiCollapsechemde" role="button" aria-expanded="true" aria-controls="multiCollapsechemde"><h5>Chemicals  <i class="la la-ellipsis-v"></i></h5></a>
                            
                            
                          </p>
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapsechemde" style="">
                                <div class="card card-body">
                      <?php
  ...
  <div class="kt-section__content kt-section__content--border">
                          <p>
                            ...
                            <a class="" data-toggle="collapse" href="#multiCollapsechemde" role="button" aria-expanded="true" aria-controls="multiCollapsechemde"><h3> <i class="la la-tasks"></i></h3></a>
                      ...
                      <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" data-toggle="tab" href="#multiCollapsechemdes1">Order</a>
                        </li>
                        
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsechemdes2">Define</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapsechemdes3">Reports</a>
                        </li>
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">More</a>
                          <div class="dropdown-menu">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="multiCollapsechemdes1" role="tabpanel">
                          <div class="card card-body">
                        <?php
                      ...
                      ?>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#chemsdeol" data-book-id="my_id_value"><?php echo $rowordc[2];?> <img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowordc[7]-$rowordc[6])>=1 && ($rowordc[7]-$rowordc[6])<=2) {
                        ?> 
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#chemsdeol" data-book-id="my_id_value"><?php echo $rowordc[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        ...
                        <div class="tab-pane" id="multiCollapsechemdes2" role="tabpanel">
                      ...
                      ?>
                        ...
                        ?>
                        <?php echo $rowactc[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinede"><i style="font-size:20px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

                        <br>
                        <?php
                      }else{
                        ?>
                        <?php echo $rowactc[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinede"><i style="font-size:20px; color:#5578eb;" class="la la-cogs"></i></a>
                        <br>
                        <?php } } 
                         ?>
                         <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
                        </div>
                        <div class="tab-pane" id="multiCollapsechemdes3" role="tabpanel">
  ...
  <!---->
                    ...
                    <tr>
                      <td style="width: 40%; vertical-align: middle;">
                        <div class="kt-section__content kt-section__content--border">
                          <p>
                            <a class="" data-toggle="collapse" href="#multiCollapseppede" role="button" aria-expanded="true" aria-controls="multiCollapseppede"><h5>PPE  <i class="la la-ellipsis-v"></i></h5></a>
                            
                            
                          </p>
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapseppede" style="">
                                <div class="card card-body">
                      ...
                      <span>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaldea"><?php echo $rowp['wppe_name'];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowp['wppe_standard']-$rowp['wppe_quantity'])>=1 && ($rowp['wppe_standard']-$rowp['wppe_quantity'])<=2) {
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalde"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaldea"><?php echo $rowp['wppe_name'];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        <?php 
                        }
                        ...
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodalde"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaldea"><?php echo $rowp['wppe_name'];?><img src="img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </span>
                      <?php }  ?>
                                </div>
  ...
  <div class="kt-section__content kt-section__content--border">
                          <p>
                            ...
                            <a class="" data-toggle="collapse" href="#multiCollapseppede" role="button" aria-expanded="true" aria-controls="multiCollapseppede"><h3> <i class="la la-tasks"></i></h3></a>
                      ...
                      <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" data-toggle="tab" href="#multiCollapseppede1">Order</a>
                        </li>
                        
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapseppede2">Define</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#multiCollapseppedede3">Reports</a>
                        </li>
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">More</a>
                          <div class="dropdown-menu">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="multiCollapseppede1" role="tabpanel">
                        <div class="card card-body">
                      ...
                      ?>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppedeol"><?php echo $rowordp[2];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></i></a>
                      ...
                      <?php
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#ppedeol" ><?php echo $rowordp[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                      ...
                      <?php  }  ?>
                        ...
                        <div class="tab-pane" id="multiCollapseppede2" role="tabpanel">
                      ...
                      ?>
                        ...
                        ?>
                        <?php echo $rowactp[2];?><a href="" style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinede"><i style="font-size:20px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

                        <br>
                        <?php
                      }else{
                        ?>
                        <?php echo $rowactp[2];?> <a href="" style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinede"><i style="font-size:20px; color:#5578eb;" class="la la-cogs"></i></a>
                        <br>
                        <?php } } 
                         ?>
                         <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
                        </div>
                        <div class="tab-pane" id="multiCollapseppedede3" role="tabpanel">
  ...
  <!---->
                    ...
                    <tr>
                      <td style="width: 50%; vertical-align: middle;">
                        <div class="kt-section__content kt-section__content--border">
                          <p>
                            <a class="" data-toggle="collapse" href="#multiCollapseapede" role="button" aria-expanded="true" aria-controls="multiCollapseapede"><h5>APE <i class="la la-ellipsis-v"></i></h5></a>
                            
                            
                          </p>
                          <div class="row">
                            <div class="col">
                              <div class="multi-collapse collapse" id="multiCollapseapede" style="">
                                <div class="card card-body">
                    ...
                    <?php
                      ...
                      <span>
                        ...
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalde"><?php echo $rowa['wape_name'];?> <img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <?php
                      }
                         if (($rowa['wape_standard']-$rowa['wape_quantity'])>=1 && ($rowa['wape_standard']-$rowa['wape_quantity'])<=2) {
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalde"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalde"><?php echo $rowa['wape_name'];?> <img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        <?php 
                        }
                        ...
                        ?>
                        <!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodalde"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
                        <a href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodalde"><?php echo $rowa['wape_name'];?> <img src="img/signal-3.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#1dc9b7;"/></a>
                        <?php } ?>
                      </a></span>
                      <?php }  ?>
                                </div>
  ...
  <div class="kt-section__content kt-section__content--border">
    <p>
      <a class="" data-toggle="collapse" href="#multiCollapseapede" role="button" aria-expanded="true" aria-controls="multiCollapseapede"><h3> <i class="la la-tasks"></i></h3></a>
      <div class="row">
        <div class="col">
          <div class="multi-collapse collapse" id="multiCollapseapede" style="">
            <div class="card card-body">
              <ul class="nav nav-pills nav-fill" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#multiCollapseapede1">Order</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#multiCollapseapede2">Define</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#multiCollapseapede2">Reports</a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">More</a>
                  <div class="dropdown-menu">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="multiCollapseapede1" role="tabpanel">
                  ...
                  while($roworda = mysqli_fetch_row($resultorda)) {
                    ...
                    <?php if (($roworda[7]-$roworda[6])>=3) {
                      ?>
                        ...
                        <a href="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apepplde"><?php echo $roworda[2];?><img src="img/signal-1.png" style="float:right; width: 17px; height: 10px; font-size:12px; color:#fd397a;" ></a>
                        <br>
                        <?php
                      }
                        ...
                        <a href="" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#apepplde" ><?php echo $roworda[2];?><img src="img/signal-2.png" style="float:right; width: 17px;height: 10px; font-size:12px; color:#ffb822;" /></a>
                        </br>
                        ...
                        <div class="tab-pane" id="multiCollapseapede2" role="tabpanel">
                      ...
                      ?>
                        ...
                        ?>
                        <?php echo $rowacta[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinede"><i style="font-size:20px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

                        <br>
                        <?php
                      }else{
                        ?>
                        <?php echo $rowacta[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinede"><i style="font-size:20px; color:#5578eb;" class="la la-cogs"></i></a>
                        <br>
                        <?php } } 
                         ?>
                         <br>
                      ...
                      <div class="tab-pane" id="multiCollapseapede3" role="tabpanel">
...
<div class="modal fade bd-example-modal-sm" id="toolsppdl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
...
<div class="modal fade bd-example-modal-sm" id="matsdeol" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title">Supply :</h5>
...
<div class="modal fade bd-example-modal-sm" id="chemsdeol" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title">Supply :</h5>
...
<div class="modal fade bd-example-modal-sm" id="ppedeol" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title">Supply :</h5>
...
<div class="modal fade bd-example-modal-sm" id="apepplde" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title">Supply :</h5>
...
<div class="modal fade bd-example-modal-sm" id="matsinsmodaldea" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
...
<div class="modal fade bd-example-modal-sm" id="ppeinsmodaldea" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
...
<div class="modal fade bd-example-modal-sm" id="chemdefinede" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/de/chems/define.php')?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="ppedefinede" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/de/ppe/define.php')?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="apedefinede" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
                              ...
                              <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                  <div class="kt-section__body">
                                    ...
                                    <?php include('controls/de/ape/define.php')?>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<div class="modal fade bd-example-modal-sm" id="srboardd" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
                            <div class="modal-dialog modal-xl">
                              <div class="modal-content">
                                <div class="modal-header">
