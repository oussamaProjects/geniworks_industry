                              ...
                              <div class="kt-widget-14__data">
                                    ...
                                    <div class="number-input">
                                        <div class="custom-quantity-input">
                                         ...
                                         <a class="quantity-btn quantity-input-up btn btn-outline-hover-success btn-sm btn-icon">
                                          ...
                                          <input min="0" readonly value="0" style=" color: #5578eb; " name="actualtc31" type="number">
                                ...
                                <div class="kt-widget-14__info" style="background-color: transparent;">
                                  <div class="kt-widget-14__info-title">
                                    ...
                                    <input  class="kt-widget-14__info-title" min="0" readonly="readonly" value="<?php echo ($showrow2[7]-$showrow2[6]);?>" style="background-color: transparent; width: 20px; text-align: center; border:0px transparent;" name="standardtc31">
                                ...
                                <div class="kt-widget-14__info" style="background-color: transparent;">
                                    ...
                                    <input type="hidden" value="<?php echo  "$showrow2[1]";?>" name="tidtc3">
...
$(document).ready(function(){
  $(".quantity-input-up").click(function(){
    var inpt = $(this).parents(".custom-quantity-input").find("[name=actualtc31]");
  ...
  $(".standard-input-up").click(function(){
    var inpt = $(this).parents(".custom-standard-input").find("[name=standardtc31]");
    var val = parseInt(inpt.val());
    if ( val < 0 ) inpt.val(val=0);
    inpt.val(val+1);
  ...
  $(".standard-input-down").click(function(){
    ...
    inpt.val(val-1);
      ...
      $(function () {
        ...
        $('.toolsdftc31').on('submit', function (e) {
