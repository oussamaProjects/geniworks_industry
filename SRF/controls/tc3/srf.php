...
$showsrf=$cdb->prepare("SELECT * FROM srf_tools_request WHERE str_owner='32' AND str_status='not approved'");
$showsrf->execute();
if ($showsrf===false) {
...
$findtool=$cdb->prepare("SELECT * FROM work_tools_tc3 WHERE wtl_internal_id='".$showsrf[2]."'");
$findtool->execute();
if ($findtool===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
  ...
  $resfind=$findtool->get_result();
                                          ...
                                          ?><?php while ($showf=$resfind->fetch_row()) { ?>
                                          	<form id="approveordertc3tools<?php echo $showsrf[0];?>">
												<div class="kt-widget-17__item">
													...
													<input type="hidden" name="apridtc3tool" value="<?php echo $showsrf[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
...
<script>
      $(function () {
        ...
        $('#approveordertc3tools<?php echo $showsrf[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/tc3/tools/approvesingle.php',
            data: $('#approveordertc3tools<?php echo $showsrf[0];?>').serialize(),
            success: function () {
...
<script>
      $(function () {
        ...
        $('#approvesrfdt1').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/tc3/tools/approve.php',
...
$showsrfm=$cdb->prepare("SELECT * FROM srf_materials_request WHERE str_owner='32' AND str_status='not approved'");
...
$findmat=$cdb->prepare("SELECT * FROM work_materials_tc3 WHERE wmt_internal_id='".$showsrfm[2]."'");
...
if ($findmat===false) {
  ...
  $resfindm=$findmat->get_result();
                                          ...
                                          ?><?php while ($showfm=$resfindm->fetch_row()) { ?>
                                          	<form id="approveordertc3mats<?php echo $showsrfm[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridtc3mats" value="<?php echo $showsrfm[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveordertc3mats<?php echo $showsrfm[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/tc3/mats/approvesingle.php',
            data: $('#approveordertc3mats<?php echo $showsrfm[0];?>').serialize(),
            success: function () {
      ...
      $(function () {
        ...
        $('#approvesrfdm').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/tc3/mats/approve.php',
...
<?php  }
$showsrfc=$cdb->prepare("SELECT * FROM srf_chemicals_request WHERE str_owner='32' AND str_status='not approved'");
$showsrfc->execute();
if ($showsrfc===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findchem=$cdb->prepare("SELECT * FROM work_chemicals_tc3 WHERE wch_internal_id='".$showsrfc[2]."'");
...
if ($findchem===false) {
  ...
  $resfindc=$findchem->get_result();
                                          ...
                                          ?><?php while ($showfc=$resfindc->fetch_row()) { ?>
											<form id="approveordertc3chems<?php echo $showsrfc[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridtc3chems" value="<?php echo $showsrfc[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveordertc3chems<?php echo $showsrfc[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/tc3/chems/approvesingle.php',
            data: $('#approveordertc3chems<?php echo $showsrfc[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
      ...
      $(function () {
        ...
        $('#approvesrfdc').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/tc3/chems/approve.php',
...
$showsrfp=$cdb->prepare("SELECT * FROM srf_ppe_request WHERE str_owner='32' AND str_status='not approved'");
$showsrfp->execute();
if ($showsrfp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findppe=$cdb->prepare("SELECT * FROM work_ppe_tc3 WHERE wppe_internal_id='".$showsrfp[2]."'");
...
if ($findppe===false) {
  ...
  $resfindp=$findppe->get_result();
                                          ...
                                          ?><?php while ($showfp=$resfindp->fetch_row()) { ?>
											<form id="approveordertc3ppe<?php echo $showsrfp[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridtc3ppe" value="<?php echo $showsrfp[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveordertc3ppe<?php echo $showsrfp[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/tc3/ppe/approvesingle.php',
            data: $('#approveordertc3ppe<?php echo $showsrfp[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
      ...
      $(function () {
        ...
        $('#approvesrfdp').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/tc3/ppe/approve.php',
...
$showsrfa=$cdb->prepare("SELECT * FROM srf_ape_request WHERE str_owner='32' AND str_status='not approved'");
$showsrfa->execute();
if ($showsrfa===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findape=$cdb->prepare("SELECT * FROM work_ape_tc3 WHERE wape_internal_id='".$showsrfa[2]."'");
...
if ($findape===false) {
  ...
  $resfinda=$findape->get_result();
                                          ...
                                          ?><?php while ($showfa=$resfinda->fetch_row()) { ?>
												<form id="approveordertc3ape<?php echo $showsrfa[0];?>">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
													...
													<input type="hidden" name="apridtc3ape" value="<?php echo $showsrfa[0];?>">
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
												<div class="kt-widget-17__foot-toolbar">
													<button style="" class="btn btn-brand btn-sm btn-upper btn-bold" type="submit">Approve</button>
...
<script>
      $(function () {
        ...
        $('#approveordertc3ape<?php echo $showsrfa[0];?>').on('submit', function (e) {

          e.preventDefault();

          $.ajax({
            type: 'post',
            url: 'controls/tc3/ape/approvesingle.php',
            data: $('#approveordertc3ape<?php echo $showsrfa[0];?>').serialize(),
            success: function () {
              alert('Successfully Defined');
            }
          });
...
<script>
      $(function () {
        ...
        $('#approvesrfda').on('submit', function (e) {
          ...
          $.ajax({
            type: 'post',
            url: 'controls/tc3/ape/approve.php',
