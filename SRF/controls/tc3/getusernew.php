...
mysqli_select_db($cdb,"ajax_demo");
$sql="SELECT wtl_name,wtl_quantity,wtl_id FROM work_tools_tc3 WHERE wtl_owner = '32'";
...
mysqli_select_db($cdb,"ajax_demo");
$sqlm="SELECT wmt_name,wmt_quantity FROM work_materials_tc3 WHERE wmt_owner = '32'";
...
mysqli_select_db($cdb,"ajax_demo");
$sqlc="SELECT wch_name,wch_quantity FROM work_chemicals_tc3 WHERE wch_owner = '32'";
...
mysqli_select_db($cdb,"ajax_demo");
$sqlp="SELECT wppe_name,wppe_quantity FROM work_ppe_tc3 WHERE wppe_owner = '32'";
...
mysqli_select_db($cdb,"ajax_demo");
$sqla="SELECT wape_name,wape_quantity FROM work_ape_tc3 WHERE wape_owner = '32'";
...
$cntsrf=$cdb->prepare("SELECT count(str_owner) FROM srf_tools_request WHERE str_owner='32'");
$cntsrf->execute();
...
<style>
								...
								<tbody>
									<tr>
											...
											<span><?php echo $rowt['wtl_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#toolsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->

												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodaltc3"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodaltc3"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a> 
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodaltc3"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#toolsinsmodaltc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
						...
						<div class="multi-collapse collapse" id="multiCollapsetools" style="">
							<div class="card card-body">
											...
											?>
												...
												?>
												<?php echo $rowact[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinetc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowact[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#tooldefinetc3"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php }
												?>
												<?php
   ...
   <!--<div class="header">
	...
	<!---->
												 ...
												 <!--<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper" data-toggle="modal" data-target="#materialsmodaltc3">Details</button>
										...
										<tr>
											...
											<span><?php echo $rowmt['wmt_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#materialsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->

												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaltc3"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaltc3"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a> 
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaltc3"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												...
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#matsinsmodaltc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactm[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinetc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactm[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#matdefinetc3"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
   ...
   <!--<div class="header">
	...
	<!---->
										...
										<tr>
											...
											<span><?php echo $rowc['wch_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodaltc3"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												...
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodaltc3"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowc['wch_quantity']>5 && $rowc['wch_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodaltc3"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowc['wch_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemicalsmodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a>--> 
												<a style="float:right;" href="" class="k-shape-font-color-4" data-toggle="modal" data-target="#cheminsmodaltc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
																</div>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactc[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinetc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactc[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#chemdefinetc3"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
   ...
   <!--<div class="header">
	...
	<!---->
										...
										<tr>
											...
											<span><?php echo $rowp['wppe_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaltc3"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												 if ($rowp['wppe_quantity']<=5 && $rowp['wppe_quantity']>=2) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaltc3"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowp['wppe_quantity']>5 && $rowp['wppe_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a>--> 
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaltc3"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowp['wppe_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right;"  class="k-shape-font-color-4" data-toggle="modal" data-target="#ppeinsmodaltc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</span>
											<?php }  ?>
																</div>
	...
	<div class="kt-section__content kt-section__content--border">
											...
											?>
												...
												?>
												<?php echo $rowactp[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinetc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowactp[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#ppedefinetc3"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br><span class="form-text text-muted">Define Resources Standards And Actual Units</span>
	...
	<!---->
										...
										<?php
											...
											<span><?php echo $rowa['wape_name'];?> 
												...
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodaltc3"><i style="font-size:24px; color:#fd397a;" class="la la-battery-empty"></i></a>
												<?php
											}
												 if ($rowa['wape_quantity']<=5 && $rowa['wape_quantity']>=2) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodaltc3"><i style="font-size:24px; color:#ffb822;" class="la la-battery-quarter"></i></a>
												<?php 
												}
												 if ($rowa['wape_quantity']>5 && $rowa['wape_quantity']<10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodaltc3"><i style="font-size:24px; color:#5578eb;" class="la la-battery-half"></i></a>
												<?php 
												}
												 if ($rowa['wape_quantity']>=10) {
												?>
												<!--<a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apemodaltc3"><i style="font-size:20px; " class="la la-folder-open "></i></a> -->
												<a style="float:right; "  class="k-shape-font-color-4" data-toggle="modal" data-target="#apeinsmodaltc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-battery-full"></i></a>
												<?php } ?>
											</a></span>
											<?php }  ?>
																</div>
									...
									while($roworda = mysqli_fetch_row($resultorda)) {
										...
										<?php if ($roworda[6]<=1) {
											...
											?>
												...
												?>
												<?php echo $rowacta[2];?><a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinetc3"><i style="font-size:24px; color:#1dc9b7;" class="la la-crosshairs"></i></a> 

												<br>
												<?php
											}else{
												?>
												<?php echo $rowacta[2];?> <a style="float:right;" class="kt-badge k-font-success" data-toggle="modal" data-target="#apedefinetc3"><i style="font-size:24px; color:#5578eb;" class="la la-cogs"></i></a>
												<br>
												<?php } }	
											   ?>
											   <br>
...
<div class="modal fade" id="materialsmodaltc3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
															...
															<div class="kt-portlet__body">
																<div class="kt-section kt-section--first">
																	<div class="kt-section__body">
																		...
																		<?php include('controls/tc3/tools/detailst.php')?>
																	</div>
																</div>
															</div>
														</div>
