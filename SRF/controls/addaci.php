...
$eqpic = $_FILES['eqpic1']['name'];
 ...
 if($eqpic!='')
 {
 	...
 	if(move_uploaded_file($_FILES['eqpic1']['tmp_name'], $upload_directory.$pic)){    
		$QueryInsertFile=$cdb->prepare("INSERT INTO asset_clean_inspection VALUES ('','11', '$ast', '$subast', '$subastid1', '$pic', '$cleanyes', '$gwyes', NOW(), 'Not Defined')");
