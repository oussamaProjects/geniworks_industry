							...
							<div class="kt-portlet">
								<div class="kt-portlet__head"  style="text-align: right;">
									<div class="kt-portlet__head-label"  style="text-align: right;">
										<h3 class="kt-portlet__head-title" style="text-align: right; color: #d3dae6 !important;">Dashboard | Inspections Manager | Assets Inspection Journal</h3>
											...
											<div class="kt-section">
												<div class="form-group row">
													<div class="col-lg-3 col-md-3 col-sm-3">
														...
														<select onChange="aassets(this);"  required="required" class="form-control kt_selectpicker"  data-width="200px">
													<option ></option>
													...
													<option value="YARDGROUND">YARDGROUND</option>
														...
														<div class="col-lg-3 col-md-3 col-sm-3">
														<select  onChange="subassets(this);" required="required" class="form-control kt_selectpicker" data-width="200px">
														...
														<div class="col-lg-3 col-md-3 col-sm-3">
														<input type="text" onChange="subassetsid(this);" placeholder="Sub-Asset ID" id="subassetid1" class="form-control kt_selectpicker" name="" style="width: 200px;">
													</div>
												</div>
												<div class="form-group row">
													<div class="col-lg-4 col-md-4 col-sm-4">
														<div class="card">
															<img src="" id="output1" class="" style="width: 100%; max-height:300px; z-index: 3;">
															<div class="card-body">
													...
													<div class="col-5" >
														<div class="kt-avatar kt-avatar--outline kt-avatar--brand kt-avatar--circle" id="kt_profile_avatar_1">
															<div class="kt-avatar__holder" style="background-image: url(img/apple-touch-icon.png);"></div>
															<label class="kt-avatar__upload" data-toggle="kt-tooltip" title="Add Picture">
																<i class="fa fa-plus"></i>
																<input type='file' onchange="loadFile1(event)" name="eqpic1" accept=".png, .jpg, .jpeg"/>
																...
																<div class="form-group row" style="padding-top: 20px;">
																	...
																	<div class="col-6" style="text-align: right;">
																		<span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
																			<label>
																				<input type="checkbox" checked="checked" name="cleanyes1">
																				<span></span>
																			</label>
																		</span>
																	</div>
    ...
    color: #ffffff;
													...
													<div class="col-6" style="text-align: right;">
														<span class="kt-switch kt-switch--outline kt-switch--icon" style="color: #00A1DB;">
															<label>
																<input type="checkbox" checked="checked" name="gwyes1">
																<span></span>
															</label>
														</span>
													</div>
...
// }
									...
									<h1 class="kt-blog-post__title kt-heading kt-heading--lg kt-heading--medium">
										...
										<div class="card-columns">
													<div id=""><?php include('controls/disinspection1.php')?>;</div>
											
										</div>
									</div>
									<div class="kt-section__content kt-section__content--border" style="border:solid 1px #ebedf2;">
									<h1 class="kt-blog-post__title kt-heading kt-heading--lg kt-heading--medium">
										Inspection For GROUNDS & YARDS
										</h1>
										<div class="card-columns">
													<div id=""><?php include('controls/disinspection2.php')?>;</div>
