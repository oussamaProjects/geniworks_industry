...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>SRF | Supply Resources From</title>
		<meta name="description" content="Form widget validation examples">
...
function showUser(str) {
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Supply Resources Form </h3>
											...
											<ul class="kt-nav kt-nav--active-bg" role="tablist">
												<li class="kt-nav__item">
													<a href="" class="kt-nav__link">
														...
														<span class="kt-nav__link-text">Documents</span>
													</a>
												</li>
												<li class="kt-nav__item">
							...
							<div class="kt-portlet">
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">Supply Resources Form</h3>
									</div>
								</div>
								...
								<form class="kt-form kt-form--label-right" id="kt_form_1">
									<div class="kt-portlet__body">
										...
										<!--<div class="form-group row">
											<label class="col-form-label col-lg-3 col-sm-12">Owner *</label>
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select required="required" class="form-control form-control" id="exampleSelects">
														<optgroup label="APM">
														<option>APM-1</option>
														<option>APM-2</option>
														</optgroup>
														<optgroup label="EUROGATE">
														<option>EUROGATE</option>
														</optgroup>
														<optgroup label="MARSA MAROC">
														<option>MM-DE</option>
														<option>MM-TC3</option>
														</optgroup>
														<optgroup label="BMCI">
														<option>BMCI</option>
														</optgroup>
												...
												<span class="form-text text-muted">Select Owner</span>
											</div>
										</div>-->
										<?php
										require('controls/zdfzfzef/45azd72dz9de5.php');
										$disq=$cdb->prepare("SELECT owner_num,owner_name FROM owners");
										$disq->execute();
										if ($disq===false) {
											echo "error ".mysql_error();
										}else{
											$resq=$disq->get_result();
										


										 ?>
										<div class="form-group row">
											<label class="col-form-label col-lg-3 col-sm-12">Resources *</label>
											<div class="col-lg-4 col-md-9 col-sm-12">
												<select name="users" onchange="showUser(this.value)" required="required" class="form-control form-control" >
												<?php
												while($rwq=$resq->fetch_row()){
												?>		
														<option value="<?php echo $rwq[0]; ?>"><?php echo $rwq[1]; ?></option>
													<?php } ?>	
													</select>
		...
		<script src="assets/js/demo1/pages/crud/forms/validation/widgets.js" type="text/javascript"></script>
