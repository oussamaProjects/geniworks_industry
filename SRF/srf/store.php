...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>Store | Resources Control Manager | MyDadje</title>
		<meta name="description" content="Sweetalert2 plugin examples">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main">
								<h3 class="kt-subheader__title">Store</h3>
...
<div class="kt-portlet">
								<div class="kt-portlet__head">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">STORE MANAGER</h3>
									</div>
								</div>
								<div class="kt-portlet__body">
									<table class="table table-bordered">
										<tr>
											<td style="width: 40%; vertical-align: middle;">APM-1</td>
											<td>
												<button type="button" class="btn btn-warning btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#apmmodal"> Details</button>
												<div class="modal fade bd-example-modal-xl" id="apmmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">APM-1 :</h5>
										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Store Status For APM-1</h3>
											</div>
										...
										<div class="kt-portlet__body">
											<div class="kt-widget-17">
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
															<a href="#"><img src="./assets/media/blog/7.jpg" class="kt-widget-17__image" alt="" title=""></a>
														</div>
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															<span class="" style="padding:5px; color:#ffb822;">To Replace : <span>1</span></span>
														</div>
														<div class="kt-widget-17__total">
															To supply : <span>0</span>
														</div>
													</div>
												</div>
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
															<a href="#"><img src="./assets/media/blog/8.jpg" class="kt-widget-17__image" alt="" title=""></a>
														</div>
														<div class="kt-widget-17__product-desc">
															<a href="#">
																<div class="kt-widget-17__title">
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															<span class="" style="padding:5px; color:#ffb822;">To Replace : <span>5</span></span>
														</div>
														<div class="kt-widget-17__total">
															To supply : <span>0</span>
														</div>
												...
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
															<a href="#"><img src="./assets/media/blog/12.jpg" class="kt-widget-17__image" alt="" title=""></a>
														</div>
														<div class="kt-widget-17__product-desc">
															<a href="#">
																<div class="kt-widget-17__title">
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															<span class="" style="padding:5px; color:#ffb822;">To Replace : <span>0</span></span>
														</div>
														<div class="kt-widget-17__total">
															To supply : <span>0</span>
														</div>
												...
												<div class="kt-widget-17__item">
													<div class="kt-widget-17__product">
														<div class="kt-widget-17__thumb">
															<a href="#"><img src="./assets/media/blog/11.jpg" class="kt-widget-17__image" alt="" title=""></a>
														</div>
														<div class="kt-widget-17__product-desc">
															<a href="#">
																<div class="kt-widget-17__title">
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															<span class="" style="padding:5px; color:#ffb822;">To Replace : <span>2</span></span>
														</div>
														<div class="kt-widget-17__total">
															To supply : <span>0</span>
														</div>
												...
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															<span class="" style="padding:5px; color:#ffb822;">To Replace <span>4</span></span>
														</div>
														<div class="kt-widget-17__total">
															 To supply : <span>0</span>
														</div>
										...
										<tr>
											<td style="width: 40%; vertical-align: middle;">EUROGATE</td>
											<td>
												<button type="button" class="btn btn-danger btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#egmodal"> Details</button>
												<div class="modal fade bd-example-modal-xl" id="egmodal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">EUROGATE :</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">×</span>
																	</button>
																</div>
										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Store Status For EUROGATE</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<div class="kt-portlet__head-toolbar-wrapper">
													<div class="dropdown dropdown-inline">
										...
										<div class="kt-portlet__body">
											<div class="kt-widget-17">
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														<div class="kt-widget-17__unit">
															To Replace : <span>0</span>
														</div>
														<div class="kt-widget-17__total">
															<span class="" style="padding:5px; color:#fd397a;">To supply : <span>7</span> </span>
														</div>
													</div>
												</div>
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														...
														<div class="kt-widget-17__total">
															<span class="" style="padding:5px; color:#fd397a;">To supply : <span>4</span></span>
														</div>
													</div>
												</div>
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														...
														<div class="kt-widget-17__total">
															<span class="" style="padding:5px; color:#fd397a;"> To supply : <span>17</span></span>
														</div>
													</div>
												</div>
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														...
														<div class="kt-widget-17__total">
															<span class="" style="padding:5px; color:#fd397a;"> To supply : <span>25</span></span>
														</div>
													</div>
												</div>
												<div class="kt-widget-17__item">
													...
													<div class="kt-widget-17__prices">
														...
														<div class="kt-widget-17__total">
															<span class="" style="padding:5px; color:#fd397a;"> To supply : <span>15</span> </span>
														</div>
													</div>
												</div>
											</div>
										...
										<tr>
											<td style="width: 40%; vertical-align: middle;">APM-2</td>
											<td>
												<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#apm2modal"> Details</button>
												<div class="modal fade bd-example-modal-xl" id="apm2modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
														<div class="modal-dialog modal-xl">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title">APM-2 :</h5>
																	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																		<span aria-hidden="true">×</span>
																	</button>
																</div>
										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Store Status For APM-2</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<div class="kt-portlet__head-toolbar-wrapper">
													<div class="dropdown dropdown-inline">
										...
										<tr>
											<td style="width: 40%; vertical-align: middle;">DE</td>
											<td>
												<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#demodal"> Details</button>
											</td>
										</tr>
										<tr>
											<td style="width: 40%; vertical-align: middle;">TC3</td>
											<td>
												<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#tc3modal"> Details</button>
											</td>
										</tr>
										<tr>
											<td style="width: 40%; vertical-align: middle;">BMCI </td>
											<td>
												<button type="button" class="btn btn-default btn-bold btn-font-sm btn-upper"  data-toggle="modal" data-target="#bmcimodal"> Details</button>
											</td>
										</tr>
