...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_tools_request WHERE str_owner='32' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$pdf->Cell(55 ,5,'',0,0,1);
$pdf->Cell(75 ,5,'SRF / Bon De Commande N#025',0,0,1);
...
$pdf->Cell(127 ,5, iconv('UTF-8', 'ISO-8859-2', 'Informations propriétaire: MM-TC3'),1,0);
...
$findtoolp=$cdb->prepare("SELECT * FROM work_tools_tc3 WHERE wtl_internal_id='".$showpsrf[2]."'");
$findtoolp->execute();
if ($findtoolp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_materials_request WHERE str_owner='32' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_materials_tc3 WHERE wmt_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_chemicals_request WHERE str_owner='32' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_chemicals_tc3 WHERE wch_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_ppe_request WHERE str_owner='32' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_ppe_tc3 WHERE wppe_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_ape_request WHERE str_owner='32' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_ape_tc3 WHERE wape_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
