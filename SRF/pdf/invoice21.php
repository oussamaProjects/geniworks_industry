...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_tools_request WHERE str_owner='21' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$pdf->Cell(55 ,5,'',0,0,1);
$pdf->Cell(75 ,5,'SRF / Bon De Commande N#026',0,0,1);
...
$pdf->Cell(47 ,5,'General Manager',1,0,'C',1);
$pdf->Cell(48 ,5,'Supply & purchase',1,0,'C',1);
$pdf->Cell(47 ,5,'General Resources',1,0,'C',1);
$pdf->Cell(48 ,5,'SRF User',1,1,'C',1);

$pdf->SetFont('Arial','',12);

$pdf->Cell(47 ,10,'Signature : ',1,0);
$pdf->Cell(48 ,10,'Signature : ',1,0);
$pdf->Cell(47 ,10,'Signature : ',1,0);
$pdf->Cell(48 ,10,'Signature : ',1,1);
...
$pdf->Cell(127 ,5, iconv('UTF-8', 'ISO-8859-2', 'Informations propriétaire: EUROGATE'),1,0);
...
$pdf->Cell(15 ,5,'Ref',1,0,'C',1);
$pdf->Cell(75 ,5,'Description',1,0,'C',1);
...
$pdf->Cell(15 ,5,$showpsrf[1],1,0);


$findtoolp=$cdb->prepare("SELECT * FROM work_tools_eg WHERE wtl_internal_id='".$showpsrf[2]."'");
$findtoolp->execute();
if ($findtoolp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_materials_request WHERE str_owner='21' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_materials_eg WHERE wmt_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_chemicals_request WHERE str_owner='21' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_chemicals_eg WHERE wch_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_ppe_request WHERE str_owner='21' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_ppe_eg WHERE wppe_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
require('../controls/zdfzfzef/de5.php');
$showpsrf=$cdb->prepare("SELECT * FROM srf_ape_request WHERE str_owner='21' AND str_status='approved'");
$showpsrf->execute();
if ($showpsrf===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
...
$findmatp=$cdb->prepare("SELECT * FROM work_ape_eg WHERE wape_internal_id='".$showpsrf[2]."'");
$findmatp->execute();
if ($findmatp===false) {
  echo "We Have Problem In Equipment Data Export Issue!";
}
