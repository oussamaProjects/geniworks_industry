					...
					<div class="kt-login-v2__body">
						...
						<div class="kt-login-v2__wrapper">
							<div class="kt-login-v2__container">
								...
								<!--begin::Form-->
								<form class="kt-login-v2__form kt-form" action="controls/re-index.php" method="post" autocomplete="off">
									...
									<div class="kt-login-v2__actions">
										...
										<button type="submit" name="accesu" class="btn btn-brand btn-elevate btn-pill" style="background-color: #00A1DB; border: #00A1DB;">Sign In</button>
									</div>
				...
				<div class="kt-grid__item">
					<div class="kt-login-v2__footer">
						...
						<div class="kt-login-v2__info">
							<a href="#" class="kt-link">&copy; 2019 GENIWORKS</a>
						</div>
					</div>
				</div>
