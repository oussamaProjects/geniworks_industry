...
<head>
    ...
    <title>Tools Manager - MyDadje</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-info m-t-10 float-left" data-toggle="modal" data-target="#add-contact">Add New Tool</button>
                                <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            	<h4 class="modal-title" id="myModalLabel">Add Tool</h4> 
                                    ...
                                    <form method='POST'  class="form-horizontal"  action='../controls/addtool.php' enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="brnd" id="ebrnd" onChange="brndFunction(this);" class="form-control" placeholder="Tool Name" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="tfunction" class="form-control" placeholder="Tool Function" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="pricetl" class="form-control" placeholder="Tool Price" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select name="tsupplier" class="form-control" placeholder="Tool Supplier" required="required">
...
<script>
    ...
    reader.readAsDataURL(event.target.files[0]);
                                ...
                                <div class="table-responsive">
                                    <?php include('../controls/showtool.php');?>
                                </div>
