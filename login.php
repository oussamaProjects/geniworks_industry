				...
				<div class="kt-grid__item  kt-grid--hor">
					...
					<div class="kt-login-v2__head">
						<div class="kt-login-v2__logo">
							<a href="#">
								<img src="img/logo-Geniworks-0.png" alt="" width="150" />
							</a>
						</div>
				...
				<div class="kt-grid__item  kt-grid  kt-grid--ver  kt-grid__item--fluid">
					...
					<div class="kt-login-v2__body">
						...
						<div class="kt-login-v2__image">
							<img src="img/Rope-Works-Agent.svg" alt="">
						</div>
						<div class="kt-login-v2__wrapper">
							<div class="kt-login-v2__container">
								<div class="kt-login-v2__title">
									<h2>Welcome to MyDADJE</h2>
                                    <h6>Please Login To Your Account</h6>
								</div>

								<!--begin::Form-->
								<form  action="controls/re1-index.php" class="kt-login-v2__form kt-form" method="post">
									 <label>Username :</label>
                                    <div class="form-group">
                                    <input  class="form-control" id="name" name="user" placeholder="username" type="text">
                                </div>
                                    <label>Password :</label>
                                    <div class="form-group">
                                    <input class="form-control" id="password" name="pass" placeholder="**********" type="password">
                                </div>

									<!--begin::Action-->
									<div class="kt-login-v2__actions">
										<a href="change-password.php" class="kt-link kt-link--brand">
											Change Password
										</a>
										<button type="submit" name="accesu" class="btn btn-brand btn-elevate" style="background-color: #00A1DB; border: #00A1DB;">Sign In</button>
									</div>
