...
<table id="demo-foo-addrow" class="responsive-table table table-bordered m-t-30 table-hover" data-paging="true" data-paging-size="7">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  data-table="Custom Head 5" style="text-align: center;">AHR</th>
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td><center><button class="btn btn-info" style="font-size: 12px;">Review</button></center></td>
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td><?php echo  "$showrow[9]";?></td>
                                                <td><?php echo  "$showrow[6]";?></td>
                                                <td><center><button class="btn btn-success" style="font-size: 12px;">Active</button></center></td>
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td><?php echo  "$showrow[9]";?></td>
                                                <td><?php echo  "$showrow[6]";?></td>
                                                <td><center><button class="btn btn-warning" style="font-size: 12px;">Repair</button></center></td>
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td><?php echo  "$showrow[9]";?></td>
                                                <td><?php echo  "$showrow[6]";?></td>
                                                <td><center><button class="btn btn-danger" style="font-size: 12px;">Broke</button></center></td>
