...
$showr=$cdb->prepare('SELECT * FROM work_materials_apm1');
$showr->execute();
if ($showr===false) {
...
<div id="delete-Material<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Delete Material</h4>
                                                ...
                                                <div class="col-lg-12 col-xlg-9 col-md-7">
                                                    <div class="card">
                                                        <ul class="nav nav-tabs profile-tab" role="tablist">
                                                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#aassets" role="tab">Material  <?php echo "$showrow[1]";?></a> </li>
                                                        </ul>
                                                        <br>
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="aassets" role="tabpanel">
                                                                <form method='POST'  class="form-horizontal"  action='../controls/deletemat.php' enctype="multipart/form-data">
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Edit Material</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                 </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="col-lg-12 col-xlg-9 col-md-7">
                                                    <div class="card">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="aassets" role="tabpanel">
                                                                <form method='POST'  class="form-horizontal"  action='../controls/editmat.php' enctype="multipart/form-data">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"   value="<?php echo "$showrow[4]";?>" name="functionm" class="form-control"   required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                  <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                      <select class="form-control" name="supplierm" placeholder="Tool Supplier" required="required">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"  value="<?php echo "$showrow[9]";?>" name="pricemat" class="form-control" required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="control-label col-md-4">Tool Picture</label>
                                                                        <div class="col-md-8">
                                                                            <img src="../controls/imgs/Materials/<?php echo "$showrow[3]";?>" alt="" width="100"/> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td>
                                                       <img src="../controls/imgs/materials/<?php echo "$showrow[3]";?>" alt="" width="50"/>    
                                                </td>
                                                ...
                                                <td class="td-actions">
                                                           <center> <a href="#edit-equipment<?php echo "$showrow[0]";?>" class="info" style=" " data-toggle="modal" data-target=""><i class="far fa-edit"></i> </a>
                                                            ...
                                                            <a href="#delete-Material<?php echo "$showrow[0]";?>" class="danger" style="color:red; " data-toggle="modal" data-target=""><i class="fas fa-trash"></i> </a>
