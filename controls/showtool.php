...
$showr=$cdb->prepare('SELECT * FROM work_tools_apm1');
$showr->execute();
if ($showr===false) {
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Edit Tool</h4>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="aassets" role="tabpanel">
                                                                <form method='POST'  class="form-horizontal"  action='../controls/edittool.php' enctype="multipart/form-data">



                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="control-label col-md-4">Tool Name</label>
                                                                        <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"   value="<?php echo "$showrow[4]";?>" name="functiont" class="form-control"   required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                  <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                      <select class="form-control" name="suppliert" placeholder="Tool Supplier" required="required">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"   value="<?php echo "$showrow[9]";?>" name="pricet" class="form-control"   required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <img src="../controls/imgs/tools/<?php echo "$showrow[3]";?>" alt="" width="100"/> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td>
                                                       <img src="../controls/imgs/tools/<?php echo "$showrow[3]";?>" alt="" width="50"/>    
                                                </td>
