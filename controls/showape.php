...
$showr=$cdb->prepare('SELECT * FROM work_ape_apm1');
$showr->execute();
if ($showr===false) {
...
<table id="demo-foo-addrow" class="responsive-table table table-bordered m-t-30 table-hover" data-paging="true" data-paging-size="7">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">APE Name</th>
...
<div id="edit-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Edit APE</h4>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="aassets" role="tabpanel">
                                                                <form method='POST'  class="form-horizontal"  action='../controls/editape.php' enctype="multipart/form-data">



                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="control-label col-md-4">APE Name</label>
                                                                        <div class="col-md-8">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"   value="<?php echo "$showrow[4]";?>" name="functiona" class="form-control"   required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                           <input type="text"   value="<?php echo "$showrow[5]";?>" name="suppliera" class="form-control"   required="required">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="control-label col-md-4">APE Pic</label>
                                                                        <div class="col-md-8">
                                                                            <img src="../controls/imgs/ape/<?php echo "$showrow[3]";?>" alt="" width="100"/> 
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <div id="delete-equipment<?php echo "$showrow[0]";?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Delete APE</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                 </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="col-lg-12 col-xlg-9 col-md-7">
                                                    <div class="card">
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="aassets" role="tabpanel">
                                                                <form method='POST'  class="form-horizontal"  action='../controls/deleteape.php' enctype="multipart/form-data">
                                ...
                                <div class="tab-pane" id="asasset" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <td>
                                                       <img src="../controls/imgs/ape/<?php echo "$showrow[3]";?>" alt="" width="50"/>    
                                                </td>
                                                <td><?php echo  "$showrow[4]";?></td>
                                                <td><?php echo  "$showrow[5]";?></td>
                                                
                                                <td class="td-actions">
                                                           <center> <a href="#c<?php echo "$showrow[0]";?>" class="info" style=" " data-toggle="modal" data-target=""><i class="far fa-edit"></i> </a>
                                                           	<a href="#delete-equipment<?php echo "$showrow[0]";?>" class="danger" style="color:red; " data-toggle="modal" data-target=""><i class="fas fa-trash"></i> </a>
