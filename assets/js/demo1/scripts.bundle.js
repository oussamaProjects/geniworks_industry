				...
				var lock = {
					...
					enable: function() {
						var enableLock = function(tablePart) {
							...
							var lockLeft = $('<div/>').addClass(pfx + 'datatàƒÔ’
V  àƒÔ’
V                  0Æ’
V          Xú’
V  H„Ô’
V           „Ô’
V   @       „Ô’
V          table__lock ' + pfx + 'datatable__lock--scroll');
...
V           „Ô’
V   @       „Ô’
V          end($('<i/>').addClass(Plugin.getOption('layout.icons.rowDetail.collapse'))));
							}
						}
					});
				});
...
V           „Ô’
V   @       „Ô’
V          il(currentPage / option.pagesNumber) *
												option.pagesNumber;
...
V           „Ô’
V   @       „Ô’
V          d('<th class="' + pfx + 'datatable__cell ' + pfx + 'datatable__toggle-detail"><span></span></th>');
							} else {
...
V           „Ô’
V  é,       „Ô’
V          ) && KTUtil.isInResponsiveRange('desktop')) {
