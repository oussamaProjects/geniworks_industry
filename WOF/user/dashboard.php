...
<div class="logo">
  ...
  <div class="card left">
    <div class="flipper">
      <div class="f c1"><i class="far fa-plus-square">
      </i>
      </div>
...
/*GAME SCREEN*/
#g{margin-top:4px}
#g .timer{width:0%;height:5px;position:absolute;top:0;background:#256480;z-index:1}
...
.pause::before{content:'PAUSED';width:100%;position:absolute;margin-top:-100px;top:50%;background:#256480;color:#fff;font:bold 80px/200px 'Open Sans';
...
.f {background:#00A1DB;z-index:1}
.b {background:#256480;opacity:0}
