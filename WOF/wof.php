...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="dadjapp/dadjeapp/css/style.css">
        <link href="assets/plugins/steps.css" rel="stylesheet">
                                                        ...
                                                        <div class="tab-pane" id="tab1">
                                                            ...
                                                            <div class="form-group row ">
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <optgroup label="HTTSA">
                                                                        <option value="HTTSA">HTTSA</option>
                                                                 ...
                                                                 <div class="col-sm-4">
                                                                    ...
                                                                    <select name="odeal1" id="odeal1" onChange="odFunction(this);ooFunction(this);" class=" form-control" required>
                                                                        <optgroup label="APM TERMINALS">
                                                                        
                                                                        <optgroup label="STS & RTG">
                                                                        ...
                                                                        <option value="BADOUH<">BADOUH</option>
                                                                        <option value="FOUAD">FOUAD</option>
                                                                        <optgroup label="Washing area">
                                                                        <option value="Planing team"> Planing team</option>
                                                                    </optgroup>
                                                                    </optgroup>
                                                                        </optgroup>
                                                                        ...
                                                                        <optgroup label="EUROGATE">
                                                                            <option value="Abdelwahid">Abdelwahid</option>
    ...
    width:          1px;       
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select name="orec1" id="orec1" onChange="orFunction(this);orrFunction(this);" class=" form-control" required>
                                                                        ...
                                                                        <optgroup label="APM TERMINALS">
                                                                        <option value="Hassane ELOUARDI">Hassane EL OUARDI</option>
                                                                        <option value="Ahmed BERRADI">Ahmed BERRADI</option>
                                                                        <option value="Jamal ARBAI">Jamal ARBAI</option>
                                                                    ...
                                                                    <optgroup label="EUROGATE">
                                                                        <option value="Mohammed Amine HANINE">Mohammed Amine HANINE</option>
                                                                        <option value="Mohamed ELMEZIANE">Mohamed ELMEZIANE</option>
                                                                    </optgroup>
                                                                    <optgroup label="HTTSA">
                                                                        <option value="Yassine BEN CHALKHA">Yassine BEN CHALKHA</option>
                                                                        <option value="Marouane FARIH">Marouane FARIH</option>
                                                                    </optgroup>
                                                                    </select><br>
                                                        ...
                                                        <div class="tab-pane" id="tab2">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4" id="onee">
                                                                    ...
                                                                    <optgroup label="HTTSA ">
                                                                        <option value="51">HTTSA - Section 1</option>
                                                                    </optgroup>
                                                                    <optgroup label="BRAVE BOYS">
                                                                        <option value="61">BRAVE BOYS - Section 1</option>
                                                                    </optgroup>
                                                                    </select>
                                                                </div>
                                                                <br>
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <label class="form-control-label">APM TERMINALS - STS section</label><br><span class="text-danger ml-2">*</span><span style="color: gray; font-size: 10px;">(Members Of APM section 1)</span>
                                                                ...
                                                                <div  style="position:relative;" id="seven">
                                                                    <label class="form-control-label">APM TERMINALS - RTG section</label><br><span class="text-danger ml-2">*</span><span style="color: gray; font-size: 10px;">(Members Of APM section 2)</span>
                                                                    <div id="sects1" name="rtg"  class=" thre selectpicker" required >
                                                                 Ahmed BERRADI<br>Achraf GHAZALI<br>Mohammed KAOUTANE
                                                                        </div>
                                                                    <br>
                                                                </div>
                                                                <div style="position:relative;" id="eight">
                                                                    <label class="form-control-label">APM TERMINALS - Washing Area Section</label><br><span class="text-danger ml-2">*</span><span style="color: gray; font-size: 10px;">(Members Of APM section 3)</span>
                                                                    <div id="sects2" name="bmc" class=" fou selectpicker"  required>
                                                                        Abdelaaziz ELOUARDI<br> Hassan EL OUARDI
                                                                        </div>
                                                                    <br>
                                                                ...
                                                                <div style="position:relative;" id="twelve">
                                                                    ...
                                                                    Ahmed NASSIMI<br>Ayoub ESSAIDI
                                                                        </div>
                                                                    <br>
                                                                ...
                                                                <div style="position:relative;" id="thirteen">
                                                                    <label class="form-control-label">EUROGATE - Section 1</label><br><span class="text-danger ml-2">*</span>
                                                                    <div id="sects7"  name="yrd" class="fiv selectpicker" required>
                                                                    Abdellah ELHARRAS<br>Ahmed LAGHBALI<br>Mohammed Amine HANINE<br>Mohammed ELMEZIANE
                                                                        </div>
                                                                    <br>
                                                                ...
                                                                <div style="position:relative;" id="fourteen">
                                                                    <label class="form-control-label">BRAVE BOYS</label><br><span class="text-danger ml-2">*</span><span style="color: gray; font-size: 10px;">(Members Of BMCI section 1)</span>
                                                                    <div id="sects8"  name="yrd" class="fiv selectpicker" required>
                                                                    Yassine BENCHALKHA<br>Khalid AIT OUALLA <br> Abdelmalek LAAFRAOUI<br> Marouane FARIH<br> Omar ELOUARDI
                                                                        </div>
                                                                    <br>
                                                            ...
                                                            <input type="text" class="form-control" id="datetime" placeholder="Select value">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select id="ot1"  class=" form-control" name="exp-month"  onChange="otpFunction(this);"  required>
                                                                        <option value="">Select</option>
                                                                        <optgroup label="Clean works">
                                                                        <option value="c-High presure">High Presure Cleaning</option>
                                                                        <option value="c-dried up">Dry Cleaning</option>
                                                                        <option value="c-scraping">Scraping</option>
                                                                        </optgroup>
                                                                        <optgroup label="Paint works">
                                                                        <option value="p-Molding">Molding</option>
                                                                        <option value="p-Cleaning">Cleaning</option>
                                                                        <option value="p-Paint">Paint</option>
                                                                        </optgroup>
                                                                    </select>
                                                                </div>
                                                            </div>
...
function secctFunction(element) {
    var secct = document.getElementById("sect1").value;
...
?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <button type="submit" class="btn btn-shadow mb-3" data-dismiss="modal" type="submit" onclick="location.href='index.php'">Finish</button>
                    </div>
                </div>
            </div>
        </div>
  ...
  crossorigin="anonymous"></script>
        ...
        <script src="assets/plugins/jquery.steps.min.js"></script>
        <script src="assets/plugins/jquery.validate.min.js"></script>
        <script src="assets/plugins/steps.js"></script>
