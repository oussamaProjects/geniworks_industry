...
<link rel="stylesheet" type="text/css" href="https://www.mamasandpapas.com/_ui/desktop/common/css/style.min.css?timeStamp=1531966622373">
...
<div id="container">
  ...
  <div class="mockup">
<a data-toggle-fullscreen class="btns" style="
  ...
  cursor: pointer; ">Fullscreen</a>
    ...
    <div class="top" id="tendina">
      <div class="status">
        <ul>
          <li class="clock"><span id="digital-clock"></span> <i class="material-icons alarm">alarm</i></li>
          
          <li class="battery" id="demo" ></li>
        </ul>
      </div>
      <div class="menu">
      ...
      <div class="calendar">
        <div class="day">
          <div class="circle-cont"><p class="circle-date"><span>20</span>March</p></div>
          <div class="days-plan"><p class="day-plan">4 plans today</p></div>
        </div>
        <div class="month">
          <ul class="weekdays">
            <li>M</li>
...
<ul class="up-plan">
            <li>
               <div class="roundhead"  style=" background: -webkit-gradient(linear, left top, left bottom, from(#1dc9b7 ), to(#11a899));
  background: linear-gradient(#1dc9b7 , #11a899);
  box-shadow: 0 2px 12px -3px #11a899; ">

            </div>
              Prepare
              <span class="secondo">spray product on the surface </span>
              <p class="up-date">3:00 min
                <span class="up-priority">
        ...
        <div class="plan-card">
          ...
          <div class="card-info">
             <div class="upcoming" style=" box-shadow: 0px 6px 10px 2px rgba(0, 0, 0, 0.0);">

          <ul class="up-plan">
            <li style="border: transparent; padding-top: 0px;">
              <a  href="#open-modal">
              <div class="roundhead" id="roundhead"  style=" width: 55px;height: 55px; background: -webkit-gradient(linear, left top, left bottom, from(#00A1db), to(#0491c4));
  background: linear-gradient(#00A1db, #0491c4);
  box-shadow: 0 2px 12px -3px #0491c4; ">
<span style="color: white; bottom: 0px;position: relative;top: 30%; font-weight: 600;" id="countdownmini"> </span>
            </div>
          </a>
          ...
          <div class="card-plans">
            <p class="todo">
              <span class="title"> Step 2 - Dry</span>
              Dry the surface after checking if there is a part should be protected before the operation <br>
              <span class="" style="  
 
  font-size: 11px;
  color: rgba(0, 0, 0, 0.5);
  font-weight: 600;
  color:#00A1db; bottom: 0;">
         
              <span style="color: #101932">status</span> In progress 

          </span>
            </p>
          <label class="label2" for="rad2">  <div class="map">
              <span class="point"></span></div></label>
          </div>
        </div>
        <div class="upcoming">
          <p class="up-title">NEXT STEPS</p>
          <ul class="up-plan">
            <?php

require('controls/zdze8efzedzdeezd/de5.php');
$selectsteps=$cdb->prepare("SELECT * FROM work_procces_steps WHERE wpst_process='cleaning' ORDER BY wpst_internal_id ASC");
$selectsteps->execute();
if ($selectsteps===false) {
  echo "We Have Problem! We will fix it soon.";
}
else{
  $resels=$selectsteps->get_result();   
 while ($showsteps=$resels->fetch_row()) {
 ...
 ?>
            ...
            <li>
              ...
              <span style="font-weight: 600;"><?php echo $showsteps[2];?></span>
              <span class="secondo">spray product on the surface </span>
              <p class="up-date"><?php echo $showsteps[4];?>min
                <span class="up-priority">
                <span style="color: #3399ff;">&#9679; </span>
              </span>
            </p>
